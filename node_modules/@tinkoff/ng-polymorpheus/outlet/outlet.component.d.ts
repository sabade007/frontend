...
import { DoCheck, OnChanges, SimpleChanges, TemplateRef } from '@angular/core';
...
export declare class PolymorpheusOutletComponent<C extends object> implements DoCheck, OnChanges {
    ...
    isAdvanced(content: PolymorpheusContent<C> | null): content is PolymorpheusTemplate<C> | TemplateRef<C> | PolymorpheusComponent<object, C>;
    ...
    guard(content: PolymorpheusContent<C> | null): content is PolymorpheusComponent<object, C>;
