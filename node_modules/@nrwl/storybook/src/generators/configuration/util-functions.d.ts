...
export declare function createRootStorybookDir(tree: Tree, js: boolean): void;
export declare function createProjectStorybookDir(tree: Tree, projectName: string, uiFramework: StorybookConfigureSchema['uiFramework'], js: boolean): void;
