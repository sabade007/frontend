    ...
    ***************************************************************************** */
    ...
    function deleteAllToCompileFile(allToCompilePath) {
        if (Array.isArray(allToCompilePath)) {
            allToCompilePath.forEach(function (file) { return fs.unlinkSync(file); });
        }
        else {
            fs.unlinkSync(allToCompilePath);
        }
    }
    ...
    function prepareAllToCompileFile(iconsSrc, entryPointTs) {
        var e_1, _a;
        var icons = fs.readdirSync(iconsSrc).filter(function (file) { return file.split(".").pop() === "svg"; });
    ...
    exports.prepareAllToCompileFile = prepareAllToCompileFile;
    exports.processIcons = processIcons;
    exports.rollupSvgo = rollupSvgo;
