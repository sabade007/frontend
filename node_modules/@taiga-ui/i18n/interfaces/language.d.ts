...
export declare type TuiLanguageCore = LanguageCore;
/**
...
export declare type TuiLanguageKit = LanguageKit;
/**
...
export declare type TuiLanguageCommerce = LanguageCommerce;
/**
...
export declare type TuiLanguageTable = LanguageTable;
/**
...
export declare type TuiLanguageEditor = LanguageEditor;
/**
 * @deprecated use {@link TuiLanguagePreview}
 */
export declare type LanguagePreview = {
    previewTexts: {
        rotate: string;
    };
    zoomTexts: {
...
export declare type TuiLanguagePreview = LanguagePreview;
 ...
 */
export interface Language extends LanguageCore, LanguageKit, LanguageCommerce, LanguageTable, LanguageEditor, LanguagePreview, TuiLanguageMeta {
}
export declare type TuiLanguage = Language;
export {};
