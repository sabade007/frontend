...
import { AbstractTuiControl, TuiActiveZoneDirective, TuiContextWithImplicit, TuiFocusableElementAccessor, TuiInputModeT } from '@taiga-ui/cdk';
...
export declare class TuiInputPhoneComponent extends AbstractTuiControl<string> implements TuiFocusableElementAccessor, TuiDataListHost<string> {
    ...
    countryCode: string;
    open: boolean;
    constructor(control: NgControl | null, changeDetectorRef: ChangeDetectorRef, selection$: Observable<unknown>, textfieldCleaner: TuiTextfieldCleanerDirective, options: TuiInputPhoneOptions);
