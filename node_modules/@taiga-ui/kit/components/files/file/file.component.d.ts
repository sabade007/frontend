...
import { TuiFileStateT } from '@taiga-ui/kit/enums';
import { TuiFileLike } from '@taiga-ui/kit/interfaces';
import { PolymorpheusContent } from '@tinkoff/ng-polymorpheus';
import { Observable } from 'rxjs';
declare type FileTexts = 'loadingError' | 'preview' | 'remove';
export declare class TuiFileComponent {
    ...
    focused: boolean;
    constructor(isMobile: boolean, sanitizer: DomSanitizer, fileTexts$: Observable<Record<FileTexts, string>>, units$: Observable<[string, string, string]>);
