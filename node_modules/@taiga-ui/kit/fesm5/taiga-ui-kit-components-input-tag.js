...
import { EMPTY_QUERY, ALWAYS_TRUE_HANDLER, ALWAYS_FALSE_HANDLER, isNativeFocusedIn, getActualTarget, setNativeFocused, typedFromEvent, preventDefault, TuiScrollService, tuiDefaultProp, TUI_FOCUSABLE_ITEM_ACCESSOR, AbstractTuiMultipleControl, TuiFocusableModule, TuiHoveredModule, TuiActiveZoneModule } from '@taiga-ui/cdk';
...
var TUI_INPUT_TAG_OPTIONS = new InjectionToken("Default parameters for input-tag", {
    factory: function () { return TUI_INPUT_TAG_DEFAULT_OPTIONS; },
});
