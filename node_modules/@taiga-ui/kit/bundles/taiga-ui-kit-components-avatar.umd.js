(function (global, factory) {
    ...
    (global = global || self, factory((global['taiga-ui'] = global['taiga-ui'] || {}, global['taiga-ui'].kit = global['taiga-ui'].kit || {}, global['taiga-ui'].kit.components = global['taiga-ui'].kit.components || {}, global['taiga-ui'].kit.components.avatar = {}), global.ng.core, global.cdk, global.core$1, global['taiga-ui'].kit.utils.format, global.ng.common, global['taiga-ui'].kit.directives));
}(this, (function (exports, core, cdk, core$1, format, common, directives) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var TUI_AVATAR_OPTIONS = new core.InjectionToken("Default parameters for avatar component", {
        factory: function () { return TUI_AVATAR_DEFAULT_OPTIONS; },
    });
    var tuiAvatarOptionsProvider = function (options) { return ({
        provide: TUI_AVATAR_OPTIONS,
        useValue: __assign(__assign({}, TUI_AVATAR_DEFAULT_OPTIONS), options),
    }); };
    ...
    var TuiAvatarComponent = /** @class */ (function () {
        ...
        Object.defineProperty(TuiAvatarComponent.prototype, "bgColor", {
            get: function () {
                return this.autoColor ? format.stringHashToHsl(this.text) : '';
            },
            enumerable: true,
            configurable: true
        });
        ...
        Object.defineProperty(TuiAvatarComponent.prototype, "computedText", {
            get: function () {
                ...
                return words.length > 1 && core$1.sizeBigger(this.size)
        ...
        TuiAvatarComponent.ctorParameters = function () { return [
            { type: undefined, decorators: [{ type: core.Inject, args: [TUI_AVATAR_OPTIONS,] }] }
        ]; };
        __decorate([
            core.Input(),
        ...
        __decorate([
            core.HostBinding('class._has-avatar')
        ...
        TuiAvatarComponent = __decorate([
            ...
            __param(0, core.Inject(TUI_AVATAR_OPTIONS))
        ], TuiAvatarComponent);
    ...
    var TuiAvatarModule = /** @class */ (function () {
        ...
        TuiAvatarModule = __decorate([
            core.NgModule({
                imports: [common.CommonModule, directives.TuiLazyLoadingModule, core$1.TuiSvgModule],
