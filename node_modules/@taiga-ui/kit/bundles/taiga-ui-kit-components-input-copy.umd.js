(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/common'), require('@angular/core'), require('@angular/forms'), require('@taiga-ui/cdk'), require('@taiga-ui/core'), require('@taiga-ui/kit/tokens'), require('rxjs'), require('rxjs/operators'), require('@taiga-ui/kit/providers'), require('@tinkoff/ng-polymorpheus')) :
    typeof define === 'function' && define.amd ? define('@taiga-ui/kit/components/input-copy', ['exports', '@angular/common', '@angular/core', '@angular/forms', '@taiga-ui/cdk', '@taiga-ui/core', '@taiga-ui/kit/tokens', 'rxjs', 'rxjs/operators', '@taiga-ui/kit/providers', '@tinkoff/ng-polymorpheus'], factory) :
    (global = global || self, factory((global['taiga-ui'] = global['taiga-ui'] || {}, global['taiga-ui'].kit = global['taiga-ui'].kit || {}, global['taiga-ui'].kit.components = global['taiga-ui'].kit.components || {}, global['taiga-ui'].kit.components['input-copy'] = {}), global.ng.common, global.ng.core, global.ng.forms, global.cdk, global.core$1, global['taiga-ui'].kit.tokens, global.rxjs, global.rxjs.operators, global['taiga-ui'].kit.providers, global.ngPolymorpheus));
}(this, (function (exports, common, core, forms, cdk, core$1, tokens, rxjs, operators, providers, ngPolymorpheus) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var TUI_INPUT_COPY_PROVIDERS = [
        providers.TUI_VALUE_ACCESSOR_PROVIDER,
        {
            provide: cdk.TUI_FOCUSABLE_ITEM_ACCESSOR,
            useExisting: core.forwardRef(function () { return TuiInputCopyComponent; }),
        },
        {
    ...
    var TuiInputCopyComponent = /** @class */ (function (_super) {
        ...
        Object.defineProperty(TuiInputCopyComponent.prototype, "hintText$", {
            get: function () {
                var _this = this;
                return this.copyTexts$.pipe(operators.switchMap(function (texts) {
                    return _this.copy$.pipe(operators.switchMap(function () {
                        return rxjs.merge(rxjs.of(_this.successMessage || texts[1]), rxjs.timer(3000).pipe(operators.mapTo(texts[0])));
                    }), operators.startWith(texts[0]));
                }));
            },
            enumerable: true,
            configurable: true
        ...
        TuiInputCopyComponent.ctorParameters = function () { return [
            ...
            { type: rxjs.Observable, decorators: [{ type: core.Inject, args: [tokens.TUI_COPY_TEXTS,] }] }
        ]; };
        __decorate([
        ...
        __decorate([
            core.HostBinding('class._has-value')
        ...
        TuiInputCopyComponent = __decorate([
            ...
            __param(3, core.Inject(core$1.TUI_TEXTFIELD_SIZE)),
            __param(4, core.Inject(tokens.TUI_COPY_TEXTS))
    ...
    var TuiInputCopyDirective = /** @class */ (function (_super) {
        ...
        TuiInputCopyDirective_1 = TuiInputCopyDirective;
        TuiInputCopyDirective.prototype.onValueChange = function (value) {
            this.host.onValueChange(value);
        };
        var TuiInputCopyDirective_1;
        TuiInputCopyDirective = TuiInputCopyDirective_1 = __decorate([
            core.Directive({
                selector: 'tui-input-copy',
                providers: [
                    {
                        provide: core$1.TUI_TEXTFIELD_HOST,
                        useExisting: core.forwardRef(function () { return TuiInputCopyDirective_1; }),
                    },
                ],
            })
    ...
    var TuiInputCopyModule = /** @class */ (function () {
        ...
        TuiInputCopyModule = __decorate([
            core.NgModule({
                ...
                exports: [TuiInputCopyComponent, TuiInputCopyDirective, core$1.TuiTextfieldComponent],
            })
        ], TuiInputCopyModule);
        return TuiInputCopyModule;
    }());

    exports.TUI_INPUT_COPY_PROVIDERS = TUI_INPUT_COPY_PROVIDERS;
