(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@taiga-ui/cdk'), require('@taiga-ui/kit/tokens'), require('rxjs'), require('@angular/common'), require('@taiga-ui/core')) :
    typeof define === 'function' && define.amd ? define('@taiga-ui/kit/components/calendar-month', ['exports', '@angular/core', '@taiga-ui/cdk', '@taiga-ui/kit/tokens', 'rxjs', '@angular/common', '@taiga-ui/core'], factory) :
    (global = global || self, factory((global['taiga-ui'] = global['taiga-ui'] || {}, global['taiga-ui'].kit = global['taiga-ui'].kit || {}, global['taiga-ui'].kit.components = global['taiga-ui'].kit.components || {}, global['taiga-ui'].kit.components['calendar-month'] = {}), global.ng.core, global.cdk, global['taiga-ui'].kit.tokens, global.rxjs, global.ng.common, global.core$1));
}(this, (function (exports, core, cdk, tokens, rxjs, common, core$1) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var TuiCalendarMonthComponent = /** @class */ (function () {
        ...
        Object.defineProperty(TuiCalendarMonthComponent.prototype, "isSingle", {
            get: function () {
                return (this.value !== null &&
                    (this.value instanceof cdk.TuiMonth || this.value.isSingleMonth));
            },
            enumerable: true,
            configurable: true
        });
        ...
        TuiCalendarMonthComponent.prototype.getItemRange = function (item) {
            ...
            if (value instanceof cdk.TuiMonth) {
        ...
        TuiCalendarMonthComponent.prototype.getTuiMonth = function (monthNumber, yearNumber) {
            return new cdk.TuiMonth(yearNumber, monthNumber);
        };
        ...
        TuiCalendarMonthComponent.prototype.isItemInsideRange = function (month) {
            var _a = this, value = _a.value, hoveredItem = _a.hoveredItem;
            if (value === null || value instanceof cdk.TuiMonth) {
                return false;
            }
            ...
            var range = cdk.TuiMonthRange.sort(value.from, hoveredItem);
        ...
        TuiCalendarMonthComponent.prototype.updateHoveredItem = function (month) {
            if (cdk.nullableSame(this.hoveredItem, month, function (a, b) { return a.monthSame(b); })) {
                return;
            }
        ...
        TuiCalendarMonthComponent.ctorParameters = function () { return [
            { type: rxjs.Observable, decorators: [{ type: core.Inject, args: [tokens.TUI_CALENDAR_MONTHS,] }] }
        ]; };
        __decorate([
            core.Input(),
            cdk.tuiDefaultProp()
        ...
        __decorate([
            core.HostBinding('class._single')
        ...
        TuiCalendarMonthComponent = __decorate([
            ...
            __param(0, core.Inject(tokens.TUI_CALENDAR_MONTHS))
    ...
    var TuiCalendarMonthModule = /** @class */ (function () {
        ...
        TuiCalendarMonthModule = __decorate([
            core.NgModule({
                imports: [
                    common.CommonModule,
                    core$1.TuiPrimitiveYearPickerModule,
                    core$1.TuiPrimitiveSpinButtonModule,
