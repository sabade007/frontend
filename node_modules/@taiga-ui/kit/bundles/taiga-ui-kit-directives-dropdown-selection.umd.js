(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/common'), require('@angular/core'), require('@taiga-ui/cdk'), require('@taiga-ui/core'), require('@taiga-ui/kit/utils/dom'), require('rxjs'), require('rxjs/operators')) :
    typeof define === 'function' && define.amd ? define('@taiga-ui/kit/directives/dropdown-selection', ['exports', '@angular/common', '@angular/core', '@taiga-ui/cdk', '@taiga-ui/core', '@taiga-ui/kit/utils/dom', 'rxjs', 'rxjs/operators'], factory) :
    (global = global || self, factory((global['taiga-ui'] = global['taiga-ui'] || {}, global['taiga-ui'].kit = global['taiga-ui'].kit || {}, global['taiga-ui'].kit.directives = global['taiga-ui'].kit.directives || {}, global['taiga-ui'].kit.directives['dropdown-selection'] = {}), global.ng.common, global.ng.core, global.cdk, global.core$1, global['taiga-ui'].kit.utils.dom, global.rxjs, global.rxjs.operators));
}(this, (function (exports, common, core, cdk, core$1, dom, rxjs, operators) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var TuiDropdownSelectionDirective = /** @class */ (function (_super) {
        ...
        function TuiDropdownSelectionDirective(documentRef, componentFactoryResolver, injector, portalService, elementRef, activeZone, shadowRootRef, customElementRef, destroy$, refresh$, changeDetectorRef, ngZone, renderer, viewContainerRef) {
            ...
            _this.visibilityHandler = cdk.ALWAYS_TRUE_HANDLER;
            ...
            rxjs.merge(cdk.typedFromEvent(_this.documentRef, 'selectionchange'), cdk.typedFromEvent(_this.documentRef, 'mouseup'), cdk.typedFromEvent(nativeElement, 'mousedown').pipe(operators.switchMapTo(cdk.typedFromEvent(nativeElement, 'mousemove').pipe(operators.takeUntil(cdk.typedFromEvent(_this.documentRef, 'mouseup'))))), cdk.typedFromEvent(nativeElement, 'keyup'))
                .pipe(operators.map(function () {
                var active = cdk.getNativeFocused(_this.documentRef);
            ...
            }), operators.distinctUntilChanged(), operators.takeUntil(destroy$))
        ...
        Object.defineProperty(TuiDropdownSelectionDirective.prototype, "rangeRect", {
            ...
            get: function () {
                ...
                switch (this.position) {
                    ...
                    case 'word':
                        return dom.getWordRange(this.range).getBoundingClientRect();
                    default:
        ...
        TuiDropdownSelectionDirective.prototype.veryVerySadInputFix = function (element) {
            ...
            ghost.style.top = cdk.px(top - hostRect.top);
            ghost.style.left = cdk.px(left - hostRect.left);
            ghost.style.width = cdk.px(width);
            ghost.style.height = cdk.px(height);
            ghost.textContent = cdk.CHAR_ZERO_WIDTH_SPACE + element.value + cdk.CHAR_NO_BREAK_SPACE;
        ...
        TuiDropdownSelectionDirective.ctorParameters = function () { return [
            ...
            { type: core.ElementRef, decorators: [{ type: core.Host }, { type: core.Inject, args: [core.ElementRef,] }] },
            { type: cdk.TuiActiveZoneDirective, decorators: [{ type: core.Inject, args: [cdk.TuiActiveZoneDirective,] }, { type: core.Optional }] },
            { type: Document, decorators: [{ type: core.Inject, args: [core$1.TUI_DOCUMENT_OR_SHADOW_ROOT,] }, { type: core.Optional }] },
            { type: core.ElementRef, decorators: [{ type: core.Inject, args: [core$1.TUI_ELEMENT_REF,] }, { type: core.Optional }] },
            { type: cdk.TuiDestroyService, decorators: [{ type: core.Inject, args: [cdk.TuiDestroyService,] }] },
            { type: cdk.TuiParentsScrollService, decorators: [{ type: core.Inject, args: [cdk.TuiParentsScrollService,] }] },
        ...
        __decorate([
            core.Input('tuiDropdownSelectionPosition')
        ...
        TuiDropdownSelectionDirective = TuiDropdownSelectionDirective_1 = __decorate([
            core.Directive({
                ...
                providers: [
                    {
                        provide: core$1.TUI_DROPDOWN_DIRECTIVE,
                        useExisting: core.forwardRef(function () { return TuiDropdownSelectionDirective_1; }),
                    },
                    cdk.TuiParentsScrollService,
                    cdk.TuiDestroyService,
                ],
            }),
            __param(0, core.Inject(common.DOCUMENT)),
            __param(1, core.Inject(core.ComponentFactoryResolver)),
            __param(2, core.Inject(core.Injector)),
            __param(3, core.Inject(cdk.TuiPortalService)),
            __param(4, core.Host()), __param(4, core.Inject(core.ElementRef)),
            __param(5, core.Inject(cdk.TuiActiveZoneDirective)),
            __param(5, core.Optional()),
            __param(6, core.Inject(core$1.TUI_DOCUMENT_OR_SHADOW_ROOT)),
            __param(6, core.Optional()),
            __param(7, core.Inject(core$1.TUI_ELEMENT_REF)),
            __param(7, core.Optional()),
            __param(8, core.Inject(cdk.TuiDestroyService)),
            __param(9, core.Inject(cdk.TuiParentsScrollService)),
            __param(10, core.Inject(core.ChangeDetectorRef)),
            __param(11, core.Inject(core.NgZone)),
            __param(12, core.Inject(core.Renderer2)),
            __param(13, core.Inject(core.ViewContainerRef))
        ], TuiDropdownSelectionDirective);
        return TuiDropdownSelectionDirective;
    }(core$1.AbstractTuiDropdown));
    ...
    var TuiDropdownSelectionModule = /** @class */ (function () {
        ...
        TuiDropdownSelectionModule = __decorate([
            core.NgModule({
                imports: [core$1.TuiDropdownBoxModule],
    ...
    exports.TuiDropdownSelectionModule = TuiDropdownSelectionModule;

    Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=taiga-ui-kit-directives-dropdown-selection.umd.js.map
