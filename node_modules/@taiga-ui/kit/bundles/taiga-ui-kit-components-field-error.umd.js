(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/forms'), require('@taiga-ui/cdk'), require('@taiga-ui/kit/tokens'), require('rxjs'), require('rxjs/operators'), require('@angular/common'), require('@taiga-ui/core')) :
    typeof define === 'function' && define.amd ? define('@taiga-ui/kit/components/field-error', ['exports', '@angular/core', '@angular/forms', '@taiga-ui/cdk', '@taiga-ui/kit/tokens', 'rxjs', 'rxjs/operators', '@angular/common', '@taiga-ui/core'], factory) :
    (global = global || self, factory((global['taiga-ui'] = global['taiga-ui'] || {}, global['taiga-ui'].kit = global['taiga-ui'].kit || {}, global['taiga-ui'].kit.components = global['taiga-ui'].kit.components || {}, global['taiga-ui'].kit.components['field-error'] = {}), global.ng.core, global.ng.forms, global.cdk, global['taiga-ui'].kit.tokens, global.rxjs, global.rxjs.operators, global.ng.common, global.core$1));
}(this, (function (exports, core, forms, cdk, tokens, rxjs, operators, common, core$1) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var TuiFieldErrorComponent = /** @class */ (function () {
        ...
        Object.defineProperty(TuiFieldErrorComponent.prototype, "change$", {
            get: function () {
                var _a, _b;
                return rxjs.merge(((_a = this.control) === null || _a === void 0 ? void 0 : _a.valueChanges) || rxjs.EMPTY, ((_b = this.control) === null || _b === void 0 ? void 0 : _b.statusChanges) || rxjs.EMPTY);
            },
            enumerable: true,
            configurable: true
        });
        ...
        TuiFieldErrorComponent.prototype.getError = function (firstError, errorContent) {
            if (firstError instanceof cdk.TuiValidationError) {
                return rxjs.of(firstError);
            }
            if (errorContent === undefined && typeof firstError === 'string') {
                return rxjs.of(new cdk.TuiValidationError(firstError));
            }
            if (rxjs.isObservable(errorContent)) {
                return errorContent.pipe(operators.map(function (error) { return new cdk.TuiValidationError(error || '', firstError); }));
            }
            return rxjs.of(new cdk.TuiValidationError(errorContent || '', firstError));
        };
        TuiFieldErrorComponent.ctorParameters = function () { return [
            ...
            { type: forms.FormArrayName, decorators: [{ type: core.Optional }, { type: core.Self }, { type: core.Inject, args: [forms.FormArrayName,] }] },
            { type: forms.FormGroupName, decorators: [{ type: core.Optional }, { type: core.Self }, { type: core.Inject, args: [forms.FormGroupName,] }] },
            { type: forms.FormGroupDirective, decorators: [{ type: core.Optional }, { type: core.Self }, { type: core.Inject, args: [forms.FormGroupDirective,] }] },
            { type: undefined, decorators: [{ type: core.Inject, args: [tokens.TUI_VALIDATION_ERRORS,] }] }
        ]; };
        __decorate([
            core.Input(),
            cdk.tuiDefaultProp()
        ...
        TuiFieldErrorComponent = __decorate([
            ...
            __param(1, core.Self()),
            __param(1, core.Inject(forms.FormArrayName)),
            __param(2, core.Optional()),
            __param(2, core.Self()),
            __param(2, core.Inject(forms.FormGroupName)),
            __param(3, core.Optional()),
            __param(3, core.Self()),
            __param(3, core.Inject(forms.FormGroupDirective)),
            __param(4, core.Inject(tokens.TUI_VALIDATION_ERRORS))
    ...
    var TuiFieldErrorModule = /** @class */ (function () {
        ...
        TuiFieldErrorModule = __decorate([
            core.NgModule({
                imports: [common.CommonModule, core$1.TuiErrorModule, forms.ReactiveFormsModule],
    ...
    exports.TuiFieldErrorComponent = TuiFieldErrorComponent;
    exports.TuiFieldErrorModule = TuiFieldErrorModule;

    Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=taiga-ui-kit-components-field-error.umd.js.map
