(function (global, factory) {
    ...
    (global = global || self, factory((global['taiga-ui'] = global['taiga-ui'] || {}, global['taiga-ui'].kit = global['taiga-ui'].kit || {}, global['taiga-ui'].kit.components = global['taiga-ui'].kit.components || {}, global['taiga-ui'].kit.components.stepper = {}), global.ng.core, global.cdk, global.core$1, global.rxjs, global.rxjs.operators, global.ng.common));
}(this, (function (exports, core, cdk, core$1, rxjs, operators, common) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var TuiStepperComponent = /** @class */ (function () {
        ...
        Object.defineProperty(TuiStepperComponent.prototype, "changes$", {
            get: function () {
                ...
                return cdk.tuiItemsQueryListObservable(this.steps).pipe(operators.delay(0));
            },
            enumerable: true,
            configurable: true
        });
        ...
        TuiStepperComponent.prototype.indexOf = function (step) {
            return cdk.tuiGetOriginalArrayFromQueryList(this.steps).findIndex(function (_a) {
        ...
        TuiStepperComponent.prototype.moveFocus = function (current, step) {
            cdk.tuiAssertIsHTMLElement(current);
            var stepElements = this.getNativeElements(this.steps);
            cdk.tuiMoveFocus(stepElements.indexOf(current), stepElements, step);
        };
        ...
        __decorate([
            core.ContentChildren(core.forwardRef(function () { return TuiStepComponent; }), { read: core.ElementRef })
        ], TuiStepperComponent.prototype, "steps", void 0);
        __decorate([
            core.Input(),
            core.HostBinding('attr.data-orientation'),
            cdk.tuiDefaultProp()
        ...
        __decorate([
            core.HostListener('keydown.arrowRight', ['$event', '1']),
            core.HostListener('keydown.arrowLeft', ['$event', '-1'])
        ], TuiStepperComponent.prototype, "onHorizontal", null);
        __decorate([
            core.HostListener('keydown.arrowDown', ['$event', '1']),
            core.HostListener('keydown.arrowUp', ['$event', '-1'])
        ...
        TuiStepperComponent = __decorate([
            core.Component({
                ...
                providers: [cdk.TuiResizeService, cdk.TuiDestroyService],
            ...
            __param(4, core.Inject(core$1.TUI_ANIMATIONS_DURATION))
        ], TuiStepperComponent);
    ...
    var TuiStepComponent = /** @class */ (function () {
        function TuiStepComponent(focusVisible$, routerLinkActive$, stepper, elementRef) {
            ...
            routerLinkActive$.pipe(operators.filter(rxjs.identity)).subscribe(function () {
                _this.activate();
            });
        ...
        TuiStepComponent.ctorParameters = function () { return [
            ...
            { type: rxjs.Observable, decorators: [{ type: core.Inject, args: [core$1.TuiRouterLinkActiveService,] }] },
            { type: TuiStepperComponent, decorators: [{ type: core.Inject, args: [TuiStepperComponent,] }] },
            { type: core.ElementRef, decorators: [{ type: core.Inject, args: [core.ElementRef,] }] }
        ]; };
        __decorate([
            core.Input(),
            core.HostBinding('attr.data-state'),
            cdk.tuiDefaultProp()
        ...
        __decorate([
            core.HostBinding('class._vertical')
        ...
        TuiStepComponent = __decorate([
            core.Component({
                ...
                changeDetection: core.ChangeDetectionStrategy.OnPush,
                providers: [cdk.TuiDestroyService, core$1.TuiRouterLinkActiveService, cdk.TuiFocusVisibleService],
                host: {
                    type: 'button',
                },
            ...
            __param(0, core.Inject(cdk.TuiFocusVisibleService)),
            __param(1, core.Inject(core$1.TuiRouterLinkActiveService)),
            __param(2, core.Inject(TuiStepperComponent)),
    ...
    var TuiStepperModule = /** @class */ (function () {
        ...
        TuiStepperModule = __decorate([
            core.NgModule({
                imports: [common.CommonModule, core$1.TuiSvgModule],
