(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@taiga-ui/cdk'), require('@taiga-ui/kit/utils'), require('@angular/core')) :
    typeof define === 'function' && define.amd ? define('@taiga-ui/kit/pipes/filter-by-input', ['exports', '@taiga-ui/cdk', '@taiga-ui/kit/utils', '@angular/core'], factory) :
    (global = global || self, factory((global['taiga-ui'] = global['taiga-ui'] || {}, global['taiga-ui'].kit = global['taiga-ui'].kit || {}, global['taiga-ui'].kit.pipes = global['taiga-ui'].kit.pipes || {}, global['taiga-ui'].kit.pipes['filter-by-input'] = {}), global.cdk, global['taiga-ui'].kit.utils, global.ng.core));
}(this, (function (exports, cdk, utils, core) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var TuiFilterByInputBase = /** @class */ (function () {
        ...
        TuiFilterByInputBase.prototype.filter2d = function (items, matcher, stringify, query) {
            ...
            var match = items.find(function (item) {
                return cdk.isPresent(_this.getMatch(item, stringify, query));
            });
            return cdk.isPresent(match)
                ? items
    ...
    var TuiFilterByInputPipe = /** @class */ (function (_super) {
        ...
        TuiFilterByInputPipe.prototype.transform = function (items, matcher) {
            ...
            return this.filter(items, matcher, cdk.TUI_DEFAULT_STRINGIFY, this.query);
        };
        ...
        TuiFilterByInputPipe = __decorate([
            ...
            __param(0, core.Inject(cdk.TUI_FOCUSABLE_ITEM_ACCESSOR))
    ...
    exports.TuiFilterByInputBase = TuiFilterByInputBase;
