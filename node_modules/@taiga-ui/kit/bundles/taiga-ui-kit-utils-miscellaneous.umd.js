(function (global, factory) {
    ...
    (global = global || self, factory((global['taiga-ui'] = global['taiga-ui'] || {}, global['taiga-ui'].kit = global['taiga-ui'].kit || {}, global['taiga-ui'].kit.utils = global['taiga-ui'].kit.utils || {}, global['taiga-ui'].kit.utils.miscellaneous = {}), global.cdk, global['taiga-ui'].kit.classes, global.rxjs, global.rxjs.operators));
    ...
    ***************************************************************************** */
    ...
    function TuiReplayControlValueChangesFactory(control, valueTransformer) {
        return control
            ? cdk.tuiReplayedValueChangesFrom(control).pipe(operators.map(function (value) {
