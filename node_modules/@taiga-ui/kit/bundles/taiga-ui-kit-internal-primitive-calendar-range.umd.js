(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@taiga-ui/cdk'), require('@taiga-ui/core'), require('@taiga-ui/kit/tokens'), require('rxjs'), require('rxjs/operators')) :
    typeof define === 'function' && define.amd ? define('@taiga-ui/kit/internal/primitive-calendar-range', ['exports', '@angular/core', '@taiga-ui/cdk', '@taiga-ui/core', '@taiga-ui/kit/tokens', 'rxjs', 'rxjs/operators'], factory) :
    (global = global || self, factory((global['taiga-ui'] = global['taiga-ui'] || {}, global['taiga-ui'].kit = global['taiga-ui'].kit || {}, global['taiga-ui'].kit.internal = global['taiga-ui'].kit.internal || {}, global['taiga-ui'].kit.internal['primitive-calendar-range'] = {}), global.ng.core, global.cdk, global.core$1, global['taiga-ui'].kit.tokens, global.rxjs, global.rxjs.operators));
}(this, (function (exports, core, cdk, core$1, tokens, rxjs, operators) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var TuiPrimitiveCalendarRangeComponent = /** @class */ (function () {
        function TuiPrimitiveCalendarRangeComponent(valueChanges, changeDetectorRef, destroy$) {
            ...
            this.defaultViewedMonthFirst = cdk.TuiMonth.currentLocal();
            this.defaultViewedMonthSecond = cdk.TuiMonth.currentLocal().append({ month: 1 });
    ...
    var TuiPrimitiveCalendarRangeModule = /** @class */ (function () {
        ...
        TuiPrimitiveCalendarRangeModule = __decorate([
            core.NgModule({
                imports: [cdk.TuiMapperPipeModule, core$1.TuiScrollbarModule, core$1.TuiCalendarModule],
