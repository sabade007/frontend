(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/forms'), require('@taiga-ui/cdk'), require('@taiga-ui/core'), require('@taiga-ui/kit/components/radio-group'), require('@angular/common')) :
    typeof define === 'function' && define.amd ? define('@taiga-ui/kit/components/radio', ['exports', '@angular/core', '@angular/forms', '@taiga-ui/cdk', '@taiga-ui/core', '@taiga-ui/kit/components/radio-group', '@angular/common'], factory) :
    (global = global || self, factory((global['taiga-ui'] = global['taiga-ui'] || {}, global['taiga-ui'].kit = global['taiga-ui'].kit || {}, global['taiga-ui'].kit.components = global['taiga-ui'].kit.components || {}, global['taiga-ui'].kit.components.radio = {}), global.ng.core, global.ng.forms, global.cdk, global.core$1, global['taiga-ui'].kit.components['radio-group'], global.ng.common));
}(this, (function (exports, core, forms, cdk, core$1, radioGroup, common) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var TUI_RADIO_OPTIONS = new core.InjectionToken("Default parameters for radio component", {
    ...
    var TuiRadioComponent = /** @class */ (function (_super) {
        ...
        TuiRadioComponent.ctorParameters = function () { return [
            ...
            { type: undefined, decorators: [{ type: core.Inject, args: [TUI_RADIO_OPTIONS,] }] },
            { type: radioGroup.TuiRadioGroupComponent, decorators: [{ type: core.Optional }, { type: core.Inject, args: [radioGroup.TuiRadioGroupComponent,] }] }
        ]; };
        __decorate([
        ...
        TuiRadioComponent = TuiRadioComponent_1 = __decorate([
                ...
                providers: [
                    {
                        ...
                        useExisting: core.forwardRef(function () { return TuiRadioComponent_1; }),
                    },
                ],
                animations: [core$1.tuiScaleIn],
            ...
            __param(2, core.Inject(core$1.TUI_ANIMATION_OPTIONS)),
            __param(3, core.Inject(TUI_RADIO_OPTIONS)),
            __param(4, core.Optional()),
            __param(4, core.Inject(radioGroup.TuiRadioGroupComponent))
        ], TuiRadioComponent);
