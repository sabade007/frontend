(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/common'), require('@angular/core'), require('@taiga-ui/cdk'), require('@taiga-ui/core'), require('rxjs'), require('rxjs/operators')) :
    typeof define === 'function' && define.amd ? define('@taiga-ui/kit/directives/dropdown-context', ['exports', '@angular/common', '@angular/core', '@taiga-ui/cdk', '@taiga-ui/core', 'rxjs', 'rxjs/operators'], factory) :
    (global = global || self, factory((global['taiga-ui'] = global['taiga-ui'] || {}, global['taiga-ui'].kit = global['taiga-ui'].kit || {}, global['taiga-ui'].kit.directives = global['taiga-ui'].kit.directives || {}, global['taiga-ui'].kit.directives['dropdown-context'] = {}), global.ng.common, global.ng.core, global.cdk, global.core$1, global.rxjs, global.rxjs.operators));
}(this, (function (exports, common, core, cdk, core$1, rxjs, operators) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var TuiDropdownContextDirective = /** @class */ (function (_super) {
        ...
        function TuiDropdownContextDirective(elementRef, documentRef, destroy$, componentFactoryResolver, injector, portalService, activeZone) {
            ...
            _this.lastClickedClientRect = cdk.EMPTY_CLIENT_RECT;
            _this.content = '';
            _this.refresh$ = rxjs.EMPTY;
            _this.context = { close: function () { return _this.closeDropdownBox(); } };
            activeZone.tuiActiveZoneChange
                .pipe(operators.filter(function (isActive) { return !isActive; }), operators.takeUntil(destroy$))
        ...
        TuiDropdownContextDirective.prototype.onArrow = function (event, down) {
            var activeElement = cdk.getNativeFocused(this.documentRef);
            ...
            var focusable = cdk.getClosestFocusable(initial, !down, this.dropdownContent);
            if (focusable === null) {
                return;
            }
        ...
        TuiDropdownContextDirective.prototype.openDropdown = function (x, y) {
            this.lastClickedClientRect = cdk.tuiPointToClientRect(x, y);
        ...
        TuiDropdownContextDirective.ctorParameters = function () { return [
            ...
            { type: cdk.TuiActiveZoneDirective }
        ]; };
        __decorate([
            core.Input('tuiDropdownContext'),
            cdk.tuiDefaultProp()
        ...
        __decorate([
            core.HostListener('contextmenu.prevent', ['$event.clientX', '$event.clientY'])
        ], TuiDropdownContextDirective.prototype, "onContextMenu", null);
        __decorate([
            core.HostListener('document:contextmenu', ['$event.target'])
        ], TuiDropdownContextDirective.prototype, "onAnotherContextOpen", null);
        __decorate([
            core.HostListener('document:keydown.arrowDown', ['$event', 'true']),
            core.HostListener('document:keydown.arrowUp', ['$event', 'false'])
        ], TuiDropdownContextDirective.prototype, "onArrow", null);
        __decorate([
            core.HostListener('document:keydown.esc', ['$event'])
        ...
        TuiDropdownContextDirective = TuiDropdownContextDirective_1 = __decorate([
            core.Directive({
                ...
                providers: [
                    ...
                    cdk.TuiActiveZoneDirective,
                    {
                        provide: core$1.TUI_DROPDOWN_DIRECTIVE,
                        useExisting: core.forwardRef(function () { return TuiDropdownContextDirective_1; }),
                    },
                ],
            }),
            __param(1, core.Inject(common.DOCUMENT)),
            __param(2, core.Inject(cdk.TuiDestroyService)),
            __param(3, core.Inject(core.ComponentFactoryResolver)),
            __param(4, core.Inject(core.Injector)),
            __param(5, core.Inject(cdk.TuiPortalService))
    ...
    exports.TuiDropdownContextModule = TuiDropdownContextModule;

    Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=taiga-ui-kit-directives-dropdown-context.umd.js.map
