(function (global, factory) {
    ...
    (global = global || self, factory((global['taiga-ui'] = global['taiga-ui'] || {}, global['taiga-ui'].kit = global['taiga-ui'].kit || {}, global['taiga-ui'].kit.directives = global['taiga-ui'].kit.directives || {}, global['taiga-ui'].kit.directives['lazy-loading'] = {}), global.ng.core, global.intersectionObserver, global.cdk, global.rxjs, global.rxjs.operators));
}(this, (function (exports, core, intersectionObserver, cdk, rxjs, operators) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var TuiLazyLoadingService = /** @class */ (function (_super) {
        ...
        function TuiLazyLoadingService(changeDetectorRef, destroy$, intersections$) {
            var _this = _super.call(this, function (subscriber) {
                return _this.src$
                    .pipe(operators.switchMap(function (src) {
                    return intersections$.pipe(operators.filter(function (_a) {
                        var _b = __read(_a, 1), isIntersecting = _b[0].isIntersecting;
                        return isIntersecting;
                    }), operators.mapTo(src), operators.catchError(function () { return rxjs.of(src); }), cdk.watch(changeDetectorRef), operators.take(1));
                }), operators.takeUntil(destroy$))
                    .subscribe(subscriber);
            }) || this;
            _this.src$ = new rxjs.Subject();
            return _this;
        }
        ...
        TuiLazyLoadingService = __decorate([
            ...
            __param(2, core.Inject(intersectionObserver.IntersectionObserverService))
    ...
    var TuiLazyLoadingDirective = /** @class */ (function () {
        ...
        TuiLazyLoadingDirective.ctorParameters = function () { return [
            { type: TuiLazyLoadingService, decorators: [{ type: core.Inject, args: [TuiLazyLoadingService,] }] },
        ...
        __decorate([
            core.HostBinding('attr.src')
        ], TuiLazyLoadingDirective.prototype, "src", void 0);
        __decorate([
            core.HostListener('load')
        ...
        TuiLazyLoadingDirective = __decorate([
            ...
            __param(0, core.Inject(TuiLazyLoadingService)),
