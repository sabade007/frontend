(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@taiga-ui/cdk'), require('@ng-web-apis/common'), require('rxjs'), require('rxjs/operators'), require('@angular/common'), require('@ng-web-apis/intersection-observer'), require('@taiga-ui/core')) :
    typeof define === 'function' && define.amd ? define('@taiga-ui/kit/components/carousel', ['exports', '@angular/core', '@taiga-ui/cdk', '@ng-web-apis/common', 'rxjs', 'rxjs/operators', '@angular/common', '@ng-web-apis/intersection-observer', '@taiga-ui/core'], factory) :
    (global = global || self, factory((global['taiga-ui'] = global['taiga-ui'] || {}, global['taiga-ui'].kit = global['taiga-ui'].kit || {}, global['taiga-ui'].kit.components = global['taiga-ui'].kit.components || {}, global['taiga-ui'].kit.components.carousel = {}), global.ng.core, global.cdk, global.common, global.rxjs, global.rxjs.operators, global.ng.common, global.intersectionObserver, global.core$1));
}(this, (function (exports, core, cdk, common, rxjs, operators, common$1, intersectionObserver, core$1) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var TuiCarouselComponent = /** @class */ (function () {
        ...
        TuiCarouselComponent.prototype.onPan = function (x) {
            ...
            this.translate = cdk.clamp(x / clientWidth + this.translate, min, 0);
        };
        ...
        TuiCarouselComponent.prototype.updateIndex = function (index) {
            this.index = cdk.clamp(index, 0, this.items.length - 1);
        ...
        __decorate([
            core.Input(),
            core.HostBinding('class._draggable'),
            cdk.tuiDefaultProp()
        ...
        __decorate([
            core.ContentChildren(cdk.TuiItemDirective, { read: core.TemplateRef })
        ], TuiCarouselComponent.prototype, "items", void 0);
        __decorate([
            core.HostBinding('class._transitioned')
        ], TuiCarouselComponent.prototype, "transitioned", void 0);
        __decorate([
            core.HostListener('touchstart', ['false']),
            core.HostListener('touchend', ['true']),
            core.HostListener('mousedown', ['false']),
            core.HostListener('document:mouseup.silent', ['true'])
    ...
    var TuiCarouselDirective = /** @class */ (function (_super) {
        ...
        function TuiCarouselDirective(elementRef, visible$) {
            ...
            _this.duration$ = new rxjs.BehaviorSubject(0);
            _this.running$ = rxjs.merge(cdk.typedFromEvent(_this.elementRef.nativeElement, 'mouseenter').pipe(operators.mapTo(false)), cdk.typedFromEvent(_this.elementRef.nativeElement, 'touchstart').pipe(operators.mapTo(false)), cdk.typedFromEvent(_this.elementRef.nativeElement, 'touchend').pipe(operators.mapTo(true)), cdk.typedFromEvent(_this.elementRef.nativeElement, 'mouseleave').pipe(operators.mapTo(true)), _this.visible$);
            _this.output$ = rxjs.combineLatest([_this.duration$, _this.running$]).pipe(operators.switchMap(function (_a) {
                var _b = __read(_a, 2), duration = _b[0], running = _b[1];
                return duration && running ? rxjs.interval(duration) : rxjs.EMPTY;
            }));
            return _this;
        }
        ...
        TuiCarouselDirective.ctorParameters = function () { return [
            { type: core.ElementRef, decorators: [{ type: core.Inject, args: [core.ElementRef,] }] },
            { type: rxjs.Observable, decorators: [{ type: core.Inject, args: [common.PAGE_VISIBILITY,] }] }
        ]; };
        __decorate([
            core.Input()
        ...
        TuiCarouselDirective = __decorate([
            ...
            __param(1, core.Inject(common.PAGE_VISIBILITY))
    ...
    var TuiCarouselAutoscrollDirective = /** @class */ (function () {
        ...
        TuiCarouselAutoscrollDirective.ctorParameters = function () { return [
            { type: rxjs.Observable, decorators: [{ type: core.Inject, args: [TuiCarouselDirective,] }] }
        ]; };
        TuiCarouselAutoscrollDirective = __decorate([
            ...
            __param(0, core.Inject(TuiCarouselDirective))
    ...
    var TuiCarouselButtonsDirective = /** @class */ (function () {
        ...
        TuiCarouselButtonsDirective = __decorate([
            core.Directive({
                ...
                providers: [
                    {
                        provide: core$1.TUI_BUTTON_OPTIONS,
    ...
    var TuiCarouselScrollDirective = /** @class */ (function () {
        function TuiCarouselScrollDirective(elementRef) {
            var _this = this;
            this.elementRef = elementRef;
            this.tuiCarouselScroll = cdk.typedFromEvent(this.elementRef.nativeElement, 'wheel').pipe(operators.filter(function (_a) {
        ...
        TuiCarouselModule = __decorate([
            core.NgModule({
                imports: [
                    ...
                    intersectionObserver.IntersectionObserverModule,
                    cdk.TuiPanModule,
                    cdk.TuiSwipeModule,
                    cdk.TuiItemModule,
                ],
    ...
    exports.CAROUSEL_BUTTON_OPTIONS = CAROUSEL_BUTTON_OPTIONS;
