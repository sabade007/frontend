(function (global, factory) {
    ...
    (global = global || self, factory((global['taiga-ui'] = global['taiga-ui'] || {}, global['taiga-ui'].kit = global['taiga-ui'].kit || {}, global['taiga-ui'].kit.utils = global['taiga-ui'].kit.utils || {}, global['taiga-ui'].kit.utils.mask = {}), global.cdk, global['taiga-ui'].kit.constants, global.core));
    ...
    ***************************************************************************** */
    ...
    function tuiCreateAutoCorrectedTimePipe(timeMode, maxValues) {
        ...
        var safeValues = __assign(__assign({}, constants.MAX_TIME_VALUES), maxValues);
    ...
    function tuiCreateTimeMask(mode, maxValues) {
        if (maxValues === void 0) { maxValues = {}; }
        var _a = __assign(__assign({}, constants.MAX_TIME_VALUES), maxValues), HH = _a.HH, MM = _a.MM, SS = _a.SS, MS = _a.MS;
