(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/forms'), require('@taiga-ui/cdk'), require('@taiga-ui/core'), require('@taiga-ui/kit/tokens'), require('rxjs'), require('rxjs/operators'), require('@angular/common'), require('@tinkoff/ng-polymorpheus')) :
    typeof define === 'function' && define.amd ? define('@taiga-ui/kit/components/input-password', ['exports', '@angular/core', '@angular/forms', '@taiga-ui/cdk', '@taiga-ui/core', '@taiga-ui/kit/tokens', 'rxjs', 'rxjs/operators', '@angular/common', '@tinkoff/ng-polymorpheus'], factory) :
    (global = global || self, factory((global['taiga-ui'] = global['taiga-ui'] || {}, global['taiga-ui'].kit = global['taiga-ui'].kit || {}, global['taiga-ui'].kit.components = global['taiga-ui'].kit.components || {}, global['taiga-ui'].kit.components['input-password'] = {}), global.ng.core, global.ng.forms, global.cdk, global.core$1, global['taiga-ui'].kit.tokens, global.rxjs, global.rxjs.operators, global.ng.common, global.ngPolymorpheus));
}(this, (function (exports, core, forms, cdk, core$1, tokens, rxjs, operators, common, ngPolymorpheus) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var TUI_INPUT_PASSWORD_OPTIONS = new core.InjectionToken("Default parameters for input password component", {
    ...
    var TuiInputPasswordComponent = /** @class */ (function (_super) {
        ...
        function TuiInputPasswordComponent(control, changeDetectorRef, textfieldSize, passwordTexts$, options, hintController, mode$) {
            ...
            _this.computedMode$ = rxjs.combineLatest([
                _this.mode$.pipe(operators.map(function (val) { return (val === 'onDark' ? 'onDark' : null); })),
                _this.hintController.change$.pipe(operators.startWith(null), operators.map(function () { return _this.hintController.mode; })),
        ...
        TuiInputPasswordComponent.ctorParameters = function () { return [
            ...
            { type: rxjs.Observable, decorators: [{ type: core.Inject, args: [tokens.TUI_PASSWORD_TEXTS,] }] },
            { type: undefined, decorators: [{ type: core.Inject, args: [TUI_INPUT_PASSWORD_OPTIONS,] }] },
        ...
        TuiInputPasswordComponent = TuiInputPasswordComponent_1 = __decorate([
                ...
                providers: [
                    {
                        ...
                        useExisting: core.forwardRef(function () { return TuiInputPasswordComponent_1; }),
                    },
                    {
            ...
            __param(2, core.Inject(core$1.TUI_TEXTFIELD_SIZE)),
            __param(3, core.Inject(tokens.TUI_PASSWORD_TEXTS)),
            __param(4, core.Inject(TUI_INPUT_PASSWORD_OPTIONS)),
            __param(5, core.Inject(core$1.TUI_HINT_WATCHED_CONTROLLER)),
                ...
                providers: [
                    {
                        ...
                        useExisting: core.forwardRef(function () { return TuiInputPasswordDirective_1; }),
                    },
                ],
            })
    ...
    exports.PASSWORD_ICON_HIDE = PASSWORD_ICON_HIDE;
    exports.PASSWORD_ICON_SHOW = PASSWORD_ICON_SHOW;
