(function (global, factory) {
    ...
    (global = global || self, factory((global['taiga-ui'] = global['taiga-ui'] || {}, global['taiga-ui'].kit = global['taiga-ui'].kit || {}, global['taiga-ui'].kit.directives = global['taiga-ui'].kit.directives || {}, global['taiga-ui'].kit.directives.highlight = {}), global.ng.common, global.ng.core, global.cdk, global.rxjs));
}(this, (function (exports, common, core, cdk, rxjs) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var TuiHighlightDirective = /** @class */ (function () {
        function TuiHighlightDirective(documentRef, elementRef, renderer, resize$) {
            ...
            this.treeWalker = this.documentRef.createTreeWalker(this.elementRef.nativeElement, NodeFilter.SHOW_TEXT, cdk.svgNodeFilter, false);
            this.tuiHighlight = '';
        ...
        TuiHighlightDirective.prototype.updateStyles = function () {
            ...
            do {
                ...
                style.left = cdk.px(left - hostRect.left);
                style.top = cdk.px(top_1 - hostRect.top);
                style.width = cdk.px(width);
                style.height = cdk.px(height);
                style.display = 'block';
                return;
