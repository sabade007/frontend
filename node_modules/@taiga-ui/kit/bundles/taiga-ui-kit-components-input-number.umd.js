(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/forms'), require('@taiga-ui/cdk'), require('@taiga-ui/core'), require('@tinkoff/ng-polymorpheus'), require('@angular/common'), require('@taiga-ui/kit/directives'), require('angular2-text-mask')) :
    typeof define === 'function' && define.amd ? define('@taiga-ui/kit/components/input-number', ['exports', '@angular/core', '@angular/forms', '@taiga-ui/cdk', '@taiga-ui/core', '@tinkoff/ng-polymorpheus', '@angular/common', '@taiga-ui/kit/directives', 'angular2-text-mask'], factory) :
    (global = global || self, factory((global['taiga-ui'] = global['taiga-ui'] || {}, global['taiga-ui'].kit = global['taiga-ui'].kit || {}, global['taiga-ui'].kit.components = global['taiga-ui'].kit.components || {}, global['taiga-ui'].kit.components['input-number'] = {}), global.ng.core, global.ng.forms, global.cdk, global.core$1, global.ngPolymorpheus, global.ng.common, global['taiga-ui'].kit.directives, global.angular2TextMask));
}(this, (function (exports, core, forms, cdk, core$1, ngPolymorpheus, common, directives, angular2TextMask) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var TuiInputNumberComponent = /** @class */ (function (_super) {
            ...
            _this.mask = function (allowNegative, decimal, decimalLimit, nativeFocusableElement) {
                return ({
                    mask: core$1.tuiCreateNumberMask({
                        ...
                        autoCorrectDecimalSymbol: core$1.tuiEnableAutoCorrectDecimalSymbol(_this.numberFormat),
                    }),
                    pipe: core$1.tuiCreateAutoCorrectedNumberPipe(decimal === 'always' ? decimalLimit : 0, _this.numberFormat.decimalSeparator, _this.numberFormat.thousandSeparator, nativeFocusableElement, allowNegative, _this.isIOS),
                    guide: false,
                });
            };
            return _this;
        ...
        TuiInputNumberComponent.prototype.onValueChange = function (value) {
            if (core$1.maskedMoneyValueIsEmpty(value)) {
            ...
            if (capped !==
                core$1.tuiMaskedNumberStringToNumber(value, this.numberFormat.decimalSeparator, this.numberFormat.thousandSeparator)) {
                this.nativeValue = this.formattedValue;
            }
        };
        TuiInputNumberComponent.prototype.onKeyDown = function (event) {
            if (!core$1.TUI_DECIMAL_SYMBOLS.includes(event.key)) {
                return;
            }
        ...
        TuiInputNumberComponent.prototype.onFocused = function (focused) {
            ...
            var nativeNumberValue = this.unfinishedValue
                ? core$1.tuiMaskedNumberStringToNumber(this.unfinishedValue, this.numberFormat.decimalSeparator, this.numberFormat.thousandSeparator)
        ...
        TuiInputNumberComponent.prototype.getFormattedValue = function (value) {
            ...
            var limit = this.decimal === 'always' || (hasFraction && this.decimal !== 'never')
                ? this.precision
                : 0;
            var fraction = hasFraction ? core$1.getFractionPartPadded(value, this.precision) : '';
            if (this.focused && this.decimal !== 'always') {
                limit = fraction.length;
            }
            return core$1.formatNumber(value, limit, this.numberFormat.decimalSeparator, this.numberFormat.thousandSeparator, this.numberFormat.zeroPadding);
        };
        ...
        Object.defineProperty(TuiInputNumberComponent.prototype, "nativeNumberValue", {
            get: function () {
                return core$1.tuiMaskedNumberStringToNumber(this.nativeValue, this.numberFormat.decimalSeparator, this.numberFormat.thousandSeparator);
            },
            enumerable: true,
            configurable: true
        });
        ...
        TuiInputNumberComponent.prototype.absoluteCapInputValue = function (inputValue) {
            var value = core$1.tuiMaskedNumberStringToNumber(inputValue, this.numberFormat.decimalSeparator, this.numberFormat.thousandSeparator);
            var capped = value < 0
        ...
        TuiInputNumberComponent.ctorParameters = function () { return [
            ...
            { type: undefined, decorators: [{ type: core.Inject, args: [core$1.TUI_NUMBER_FORMAT,] }] },
        ...
        __decorate([
            core.HostListener('keydown.0', ['$event'])
        ...
        TuiInputNumberComponent = TuiInputNumberComponent_1 = __decorate([
                ...
                providers: [
                    {
                        ...
                        useExisting: core.forwardRef(function () { return TuiInputNumberComponent_1; }),
                    },
                    {
                        provide: cdk.AbstractTuiControl,
                        useExisting: core.forwardRef(function () { return TuiInputNumberComponent_1; }),
                    },
                ],
            ...
            __param(2, core.Inject(core$1.TUI_NUMBER_FORMAT)),
    ...
    var TuiInputNumberDirective = /** @class */ (function (_super) {
        ...
        TuiInputNumberDirective = TuiInputNumberDirective_1 = __decorate([
            core.Directive({
                ...
                providers: [
                    {
                        provide: core$1.TUI_TEXTFIELD_HOST,
                        useExisting: core.forwardRef(function () { return TuiInputNumberDirective_1; }),
                    },
                ],
            })
        ], TuiInputNumberDirective);
        return TuiInputNumberDirective;
    }(core$1.TuiAbstractTextfieldHost));
    ...
    var TuiInputNumberModule = /** @class */ (function () {
        ...
        TuiInputNumberModule = __decorate([
            core.NgModule({
                ...
                exports: [TuiInputNumberComponent, TuiInputNumberDirective, core$1.TuiTextfieldComponent],
            })
