(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/forms'), require('@taiga-ui/cdk'), require('@taiga-ui/core'), require('@taiga-ui/kit/components/arrow'), require('@taiga-ui/kit/tokens'), require('@taiga-ui/kit/components/select-option'), require('@taiga-ui/kit/providers'), require('@angular/common'), require('@tinkoff/ng-polymorpheus')) :
    typeof define === 'function' && define.amd ? define('@taiga-ui/kit/components/combo-box', ['exports', '@angular/core', '@angular/forms', '@taiga-ui/cdk', '@taiga-ui/core', '@taiga-ui/kit/components/arrow', '@taiga-ui/kit/tokens', '@taiga-ui/kit/components/select-option', '@taiga-ui/kit/providers', '@angular/common', '@tinkoff/ng-polymorpheus'], factory) :
    (global = global || self, factory((global['taiga-ui'] = global['taiga-ui'] || {}, global['taiga-ui'].kit = global['taiga-ui'].kit || {}, global['taiga-ui'].kit.components = global['taiga-ui'].kit.components || {}, global['taiga-ui'].kit.components['combo-box'] = {}), global.ng.core, global.ng.forms, global.cdk, global.core$1, global['taiga-ui'].kit.components.arrow, global['taiga-ui'].kit.tokens, global['taiga-ui'].kit.components['select-option'], global['taiga-ui'].kit.providers, global.ng.common, global.ngPolymorpheus));
}(this, (function (exports, core, forms, cdk, core$1, arrow, tokens, selectOption, providers, common, ngPolymorpheus) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var COMBOBOX_OPTION = selectOption.TUI_SELECT_OPTION;
    var TUI_COMBO_BOX_PROVIDERS = [
        {
            provide: cdk.TUI_FOCUSABLE_ITEM_ACCESSOR,
            useExisting: core.forwardRef(function () { return TuiComboBoxComponent; }),
        },
        {
    ...
    var TuiComboBoxComponent = /** @class */ (function (_super) {
        ...
        function TuiComboBoxComponent(control, changeDetectorRef, arrowMode, itemsHandlers) {
            ...
            _this.strictMatcher = cdk.TUI_STRICT_MATCHER;
        ...
        Object.defineProperty(TuiComboBoxComponent.prototype, "showValueTemplate", {
            get: function () {
                return cdk.isPresent(this.value) && !this.focused;
            },
            enumerable: true,
            configurable: true
        });
        ...
        TuiComboBoxComponent = __decorate([
            ...
            __param(2, core.Inject(arrow.TUI_ARROW_MODE)),
            __param(3, core.Inject(tokens.TUI_ITEMS_HANDLERS))
    ...
    var TuiComboBoxDirective = /** @class */ (function (_super) {
        ...
        TuiComboBoxDirective_1 = TuiComboBoxDirective;
                ...
                providers: [
                    {
                        ...
                        useExisting: core.forwardRef(function () { return TuiComboBoxDirective_1; }),
                    },
                ],
            })
    ...
    var TuiComboBoxStrictDirective = /** @class */ (function () {
        ...
        TuiComboBoxStrictDirective.ctorParameters = function () { return [
            { type: TuiComboBoxComponent, decorators: [{ type: core.Inject, args: [TuiComboBoxComponent,] }] }
        ]; };
        __decorate([
            core.Input(),
            cdk.tuiDefaultProp()
        ...
        TuiComboBoxStrictDirective = __decorate([
            ...
            __param(0, core.Inject(TuiComboBoxComponent))
    ...
    exports.COMBOBOX_OPTION = COMBOBOX_OPTION;
    exports.TUI_COMBO_BOX_PROVIDERS = TUI_COMBO_BOX_PROVIDERS;
