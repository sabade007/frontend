(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/forms'), require('@taiga-ui/cdk'), require('@taiga-ui/core'), require('@taiga-ui/kit/tokens'), require('@taiga-ui/kit/providers'), require('rxjs'), require('rxjs/operators'), require('@angular/common'), require('@taiga-ui/kit/components/calendar-month')) :
    typeof define === 'function' && define.amd ? define('@taiga-ui/kit/components/input-month', ['exports', '@angular/core', '@angular/forms', '@taiga-ui/cdk', '@taiga-ui/core', '@taiga-ui/kit/tokens', '@taiga-ui/kit/providers', 'rxjs', 'rxjs/operators', '@angular/common', '@taiga-ui/kit/components/calendar-month'], factory) :
    (global = global || self, factory((global['taiga-ui'] = global['taiga-ui'] || {}, global['taiga-ui'].kit = global['taiga-ui'].kit || {}, global['taiga-ui'].kit.components = global['taiga-ui'].kit.components || {}, global['taiga-ui'].kit.components['input-month'] = {}), global.ng.core, global.ng.forms, global.cdk, global.core$1, global['taiga-ui'].kit.tokens, global['taiga-ui'].kit.providers, global.rxjs, global.rxjs.operators, global.ng.common, global['taiga-ui'].kit.components['calendar-month']));
}(this, (function (exports, core, forms, cdk, core$1, tokens, providers, rxjs, operators, common, calendarMonth) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var TUI_INPUT_MONTH_PROVIDERS = [
        {
            provide: cdk.TUI_FOCUSABLE_ITEM_ACCESSOR,
            useExisting: core.forwardRef(function () { return TuiInputMonthComponent; }),
        },
        {
    ...
    var TuiInputMonthComponent = /** @class */ (function (_super) {
        ...
        function TuiInputMonthComponent(control, changeDetectorRef, textfieldSize, formatter) {
            ...
            _this.open = false;
            _this.activeYear = _this.value || cdk.TuiDay.currentLocal();
            return _this;
        }
        ...
        TuiInputMonthComponent.ctorParameters = function () { return [
            ...
            { type: undefined, decorators: [{ type: core.Inject, args: [tokens.TUI_MONTH_FORMATTER,] }] }
        ]; };
        __decorate([
        ...
        TuiInputMonthComponent = __decorate([
            ...
            __param(3, core.Inject(tokens.TUI_MONTH_FORMATTER))
    ...
    var TuiInputMonthDirective = /** @class */ (function (_super) {
        ...
        TuiInputMonthDirective.ctorParameters = function () { return [
            { type: TuiInputMonthComponent, decorators: [{ type: core.Inject, args: [cdk.AbstractTuiControl,] }] },
            { type: undefined, decorators: [{ type: core.Inject, args: [tokens.TUI_MONTH_FORMATTER,] }] },
                ...
                providers: [
                    {
                        ...
                        useExisting: core.forwardRef(function () { return TuiInputMonthDirective_1; }),
                    },
                    cdk.TuiDestroyService,
                ],
            }),
            __param(0, core.Inject(cdk.AbstractTuiControl)),
            __param(1, core.Inject(tokens.TUI_MONTH_FORMATTER)),
    ...
    var TuiInputMonthModule = /** @class */ (function () {
        ...
        TuiInputMonthModule = __decorate([
            core.NgModule({
                imports: [
                    common.CommonModule,
                    calendarMonth.TuiCalendarMonthModule,
                ...
                exports: [TuiInputMonthComponent, TuiInputMonthDirective, core$1.TuiTextfieldComponent],
            })
        ], TuiInputMonthModule);
        return TuiInputMonthModule;
    }());

    exports.TUI_INPUT_MONTH_PROVIDERS = TUI_INPUT_MONTH_PROVIDERS;
