(function (global, factory) {
    ...
    (global = global || self, factory((global['taiga-ui'] = global['taiga-ui'] || {}, global['taiga-ui'].kit = global['taiga-ui'].kit || {}, global['taiga-ui'].kit.components = global['taiga-ui'].kit.components || {}, global['taiga-ui'].kit.components.input = {}), global.ng.core, global.ng.forms, global.cdk, global.core$1, global['taiga-ui'].kit.providers, global.ng.common));
}(this, (function (exports, core, forms, cdk, core$1, providers, common) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var TUI_INPUT_PROVIDERS = [
        ...
        providers.FIXED_DROPDOWN_CONTROLLER_PROVIDER,
        {
            ...
            useExisting: core.forwardRef(function () { return TuiInputComponent; }),
        },
        {
                ...
                providers: [
                    {
                        ...
                        useExisting: core.forwardRef(function () { return TuiInputDirective_1; }),
                    },
                ],
            })
        ], TuiInputDirective);
    ...
    var TuiInputModule = /** @class */ (function () {
        ...
        TuiInputModule = __decorate([
            core.NgModule({
                ...
                exports: [TuiInputComponent, TuiInputDirective, core$1.TuiTextfieldComponent],
            })
        ], TuiInputModule);
        return TuiInputModule;
    }());

    exports.TUI_INPUT_PROVIDERS = TUI_INPUT_PROVIDERS;
