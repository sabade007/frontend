(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/common'), require('@angular/core'), require('@angular/forms'), require('@taiga-ui/cdk'), require('@taiga-ui/kit/abstract'), require('@taiga-ui/kit/components/slider'), require('@taiga-ui/kit/constants'), require('@taiga-ui/kit/tokens'), require('@taiga-ui/kit/utils'), require('rxjs'), require('@taiga-ui/core'), require('rxjs/operators')) :
    typeof define === 'function' && define.amd ? define('@taiga-ui/kit/components/range', ['exports', '@angular/common', '@angular/core', '@angular/forms', '@taiga-ui/cdk', '@taiga-ui/kit/abstract', '@taiga-ui/kit/components/slider', '@taiga-ui/kit/constants', '@taiga-ui/kit/tokens', '@taiga-ui/kit/utils', 'rxjs', '@taiga-ui/core', 'rxjs/operators'], factory) :
    (global = global || self, factory((global['taiga-ui'] = global['taiga-ui'] || {}, global['taiga-ui'].kit = global['taiga-ui'].kit || {}, global['taiga-ui'].kit.components = global['taiga-ui'].kit.components || {}, global['taiga-ui'].kit.components.range = {}), global.ng.common, global.ng.core, global.ng.forms, global.cdk, global['taiga-ui'].kit.abstract, global['taiga-ui'].kit.components.slider, global['taiga-ui'].kit.constants, global['taiga-ui'].kit.tokens, global['taiga-ui'].kit.utils, global.rxjs, global.core$1, global.rxjs.operators));
}(this, (function (exports, common, core, forms, cdk, abstract, slider, constants, tokens, utils, rxjs, core$1, operators) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var TuiRangeComponent = /** @class */ (function (_super) {
        ...
        function TuiRangeComponent(control, changeDetectorRef, documentRef, elementRef, fromToTexts$, isNew) {
            ...
            _this.segments = 0;
            _this.keySteps = null;
            _this.slidersRefs = cdk.EMPTY_QUERY;
        ...
        Object.defineProperty(TuiRangeComponent.prototype, "fractionStep", {
            get: function () {
                ...
                return this.quantum ? this.quantum / (this.max - this.min) : abstract.SLIDER_KEYBOARD_STEP;
            },
            enumerable: true,
            configurable: true
        });
        ...
        TuiRangeComponent.prototype.fractionGuard = function (fraction) {
            return cdk.clamp(cdk.quantize(fraction, this.fractionStep), 0, 1);
        };
        TuiRangeComponent.prototype.getValueFromFraction = function (fraction) {
            var percentage = this.fractionGuard(fraction) * 100;
            return utils.tuiPercentageToKeyStepValue(percentage, this.computedKeySteps);
        };
        ...
        TuiRangeComponent.prototype.valueGuard = function (value) {
            return cdk.clamp(this.quantum
                ? cdk.round(Math.round(value / this.quantum) * this.quantum, constants.TUI_FLOATING_PRECISION)
        ...
        TuiRangeComponent.prototype.computePureKeySteps = function (keySteps, min, max) {
            if (keySteps && utils.tuiCheckKeyStepsHaveMinMaxPercents(keySteps)) {
                return keySteps;
            }
            // TODO replace all function by `return keySteps || [[0, min], [100, max]]` in v3.0
            cdk.tuiAssert.assert(!keySteps, '\n' +
        ...
        TuiRangeComponent.ctorParameters = function () { return [
            ...
            { type: TuiNewRangeDirective, decorators: [{ type: core.Optional }, { type: core.Inject, args: [TuiNewRangeDirective,] }] }
        ]; };
        __decorate([
            core.Input(),
            cdk.tuiDefaultProp()
        ...
        __decorate([
            core.HostListener('keydown.arrowUp.prevent', ['1', '$event.target']),
            core.HostListener('keydown.arrowRight.prevent', ['1', '$event.target']),
            core.HostListener('keydown.arrowLeft.prevent', ['-1', '$event.target']),
            core.HostListener('keydown.arrowDown.prevent', ['-1', '$event.target'])
        ...
        TuiRangeComponent = TuiRangeComponent_1 = __decorate([
                ...
                providers: [
                    {
                        ...
                        useExisting: core.forwardRef(function () { return TuiRangeComponent_1; }),
                    },
                ],
            ...
            __param(4, core.Inject(tokens.TUI_FROM_TO_TEXTS)),
            __param(5, core.Optional()),
            __param(5, core.Inject(TuiNewRangeDirective))
        ], TuiRangeComponent);
        return TuiRangeComponent;
    }(abstract.AbstractTuiSlider));
    ...
    var TuiRangeChangeDirective = /** @class */ (function () {
        function TuiRangeChangeDirective(documentRef, elementRef, range, destroy$) {
             ...
             */
            this.pointerDown$ = rxjs.merge(cdk.typedFromEvent(this.elementRef.nativeElement, 'touchstart', { passive: true }).pipe(operators.filter(function (_a) {
                var touches = _a.touches;
                return touches.length === 1;
            }), operators.map(function (_a) {
                var touches = _a.touches;
                return touches[0];
            })), cdk.typedFromEvent(this.elementRef.nativeElement, 'mousedown', { passive: true }));
            this.pointerMove$ = rxjs.merge(cdk.typedFromEvent(this.documentRef, 'touchmove').pipe(operators.filter(function (_a) {
                var touches = _a.touches;
                return touches.length === 1;
            }), operators.map(function (_a) {
                var touches = _a.touches;
                return touches[0];
            })), cdk.typedFromEvent(this.documentRef, 'mousemove'));
            this.pointerUp$ = rxjs.merge(cdk.typedFromEvent(this.documentRef, 'touchend', { passive: true }), cdk.typedFromEvent(this.documentRef, 'mouseup', { passive: true }));
            this.activeThumbChange = new core.EventEmitter();
            var activeThumb;
            this.pointerDown$
                ...
                return cdk.clamp(_this.getFractionFromEvents(clientX), 0, 1);
        ...
        TuiRangeChangeDirective.ctorParameters = function () { return [
            { type: Document, decorators: [{ type: core.Inject, args: [common.DOCUMENT,] }] },
            { type: core.ElementRef, decorators: [{ type: core.Inject, args: [core.ElementRef,] }] },
            { type: TuiRangeComponent, decorators: [{ type: core.Inject, args: [TuiRangeComponent,] }] },
        ...
        TuiRangeChangeDirective = __decorate([
            ...
            __param(2, core.Inject(TuiRangeComponent)),
        ...
        TuiRangeModule = __decorate([
            core.NgModule({
                imports: [
                    ...
                    core$1.TuiFormatNumberPipeModule,
                    slider.TuiSliderModule,
                    forms.FormsModule,
                ],
    ...
    exports.TuiNewRangeDirective = TuiNewRangeDirective;
