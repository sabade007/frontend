(function (global, factory) {
    ...
    (global = global || self, factory((global['taiga-ui'] = global['taiga-ui'] || {}, global['taiga-ui'].kit = global['taiga-ui'].kit || {}, global['taiga-ui'].kit.components = global['taiga-ui'].kit.components || {}, global['taiga-ui'].kit.components.rating = {}), global.ng.core, global.ng.forms, global.cdk, global.core$1));
}(this, (function (exports, core, forms, cdk, core$1) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var TUI_RATING_OPTIONS = new core.InjectionToken("Default parameters for rating component", {
        factory: function () { return TUI_RATING_DEFAULT_OPTIONS; },
    });
    var tuiRatingOptionsProvider = function (options) { return ({
        provide: TUI_RATING_OPTIONS,
        useValue: __assign(__assign({}, TUI_RATING_DEFAULT_OPTIONS), options),
    }); };
    ...
    var TuiRatingComponent = /** @class */ (function (_super) {
        ...
        TuiRatingComponent.ctorParameters = function () { return [
            ...
            { type: undefined, decorators: [{ type: core.Inject, args: [TUI_RATING_OPTIONS,] }] }
        ]; };
        __decorate([
        ...
        TuiRatingComponent = TuiRatingComponent_1 = __decorate([
                ...
                providers: [
                    {
                        ...
                        useExisting: core.forwardRef(function () { return TuiRatingComponent_1; }),
                    },
                ],
            ...
            __param(2, core.Inject(TUI_RATING_OPTIONS))
        ], TuiRatingComponent);
