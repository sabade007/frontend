(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@taiga-ui/cdk'), require('@taiga-ui/core'), require('rxjs'), require('@angular/common'), require('@tinkoff/ng-polymorpheus'), require('rxjs/operators'), require('@taiga-ui/cdk/services')) :
    typeof define === 'function' && define.amd ? define('@taiga-ui/kit/components/push', ['exports', '@angular/core', '@taiga-ui/cdk', '@taiga-ui/core', 'rxjs', '@angular/common', '@tinkoff/ng-polymorpheus', 'rxjs/operators', '@taiga-ui/cdk/services'], factory) :
    (global = global || self, factory((global['taiga-ui'] = global['taiga-ui'] || {}, global['taiga-ui'].kit = global['taiga-ui'].kit || {}, global['taiga-ui'].kit.components = global['taiga-ui'].kit.components || {}, global['taiga-ui'].kit.components.push = {}), global.ng.core, global.cdk, global.core$1, global.rxjs, global.ng.common, global.ngPolymorpheus, global.rxjs.operators, global.services));
}(this, (function (exports, core, cdk, core$1, rxjs, common, ngPolymorpheus, operators, services) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var TuiPushComponent = /** @class */ (function () {
        ...
        TuiPushComponent = __decorate([
            ...
            __param(0, core.Inject(core$1.TUI_CLOSE_WORD))
        ], TuiPushComponent);
    ...
    var TuiPushDirective = /** @class */ (function (_super) {
        ...
        function TuiPushDirective(modeDirective) {
            ...
            _this.size = 's';
            _this.shape = null;
            _this.change$ = ((_a = _this.modeDirective) === null || _a === void 0 ? void 0 : _a.change$) || new rxjs.Subject();
            return _this;
        }
        ...
        TuiPushDirective.ctorParameters = function () { return [
            { type: core$1.TuiModeDirective, decorators: [{ type: core.Optional }, { type: core.SkipSelf }, { type: core.Inject, args: [core$1.TuiModeDirective,] }] }
        ]; };
        TuiPushDirective = TuiPushDirective_1 = __decorate([
            ...
            __param(0, core.Inject(core$1.TuiModeDirective))
        ], TuiPushDirective);
        return TuiPushDirective;
    }(core$1.TuiModeDirective));
    ...
    var TuiPushAlertDirective = /** @class */ (function (_super) {
        ...
        function TuiPushAlertDirective(template, changeDetectorRef, destroy$, push) {
            ...
            _this.show$
                .pipe(operators.switchMap(function (show) { return (show ? push.open(_this) : rxjs.EMPTY); }), operators.takeUntil(destroy$))
                .subscribe();
            return _this;
        }
        ...
        TuiPushAlertDirective.ctorParameters = function () { return [
            ...
            { type: TuiPushService, decorators: [{ type: core.Inject, args: [core.forwardRef(function () { return TuiPushService; }),] }] }
        ]; };
        __decorate([
            core.Input()
        ...
        TuiPushAlertDirective = __decorate([
            ...
            __param(3, core.Inject(core.forwardRef(function () { return TuiPushService; })))
    ...
    var TuiPushAlertComponent = /** @class */ (function () {
        ...
        TuiPushAlertComponent = __decorate([
            core.Component({
                ...
                changeDetection: core.ChangeDetectionStrategy.OnPush,
                animations: [core$1.tuiFadeIn, core$1.tuiSlideInRight, core$1.tuiHeightCollapse],
                host: { role: 'alert' },
    ...
    var TuiPushService = /** @class */ (function (_super) {
        ...
        function TuiPushService() {
            ...
            _this.component = new ngPolymorpheus.PolymorpheusComponent(TuiPushAlertComponent);
        ...
        TuiPushService.ɵprov = core.ɵɵdefineInjectable({ factory: function TuiPushService_Factory() { return new TuiPushService(core.ɵɵinject(services.TuiIdService)); }, token: TuiPushService, providedIn: "root" });
        ...
        TuiPushModule = __decorate([
            core.NgModule({
                imports: [
                    ...
                    core$1.TuiSvgModule,
                    core$1.TuiFormatDatePipeModule,
                ],
                declarations: [
                    TuiPushComponent,
                    TuiPushDirective,
