(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@taiga-ui/cdk'), require('@taiga-ui/core'), require('@taiga-ui/kit/constants'), require('@taiga-ui/kit/tokens'), require('rxjs'), require('rxjs/operators'), require('@angular/common'), require('@taiga-ui/kit/internal/primitive-calendar-range')) :
    typeof define === 'function' && define.amd ? define('@taiga-ui/kit/components/calendar-range', ['exports', '@angular/core', '@taiga-ui/cdk', '@taiga-ui/core', '@taiga-ui/kit/constants', '@taiga-ui/kit/tokens', 'rxjs', 'rxjs/operators', '@angular/common', '@taiga-ui/kit/internal/primitive-calendar-range'], factory) :
    (global = global || self, factory((global['taiga-ui'] = global['taiga-ui'] || {}, global['taiga-ui'].kit = global['taiga-ui'].kit || {}, global['taiga-ui'].kit.components = global['taiga-ui'].kit.components || {}, global['taiga-ui'].kit.components['calendar-range'] = {}), global.ng.core, global.cdk, global.core$1, global['taiga-ui'].kit.constants, global['taiga-ui'].kit.tokens, global.rxjs, global.rxjs.operators, global.ng.common, global['taiga-ui'].kit.internal['primitive-calendar-range']));
}(this, (function (exports, core, cdk, core$1, constants, tokens, rxjs, operators, common, primitiveCalendarRange) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var TuiCalendarRangeComponent = /** @class */ (function () {
        function TuiCalendarRangeComponent(valueChanges, changeDetectorRef, destroy$, otherDateText$) {
            ...
            this.defaultViewedMonth = cdk.TuiMonth.currentLocal();
            this.disabledItemHandler = cdk.ALWAYS_FALSE_HANDLER;
            this.markerHandler = core$1.TUI_DEFAULT_MARKER_HANDLER;
            this.items = [];
        ...
        TuiCalendarRangeComponent.prototype.onDayClick = function (day) {
            ...
            this.updateValue(cdk.TuiDayRange.sort(value.from, day));
        };
        ...
        TuiCalendarRangeComponent.ctorParameters = function () { return [
            { type: rxjs.Observable, decorators: [{ type: core.Inject, args: [tokens.TUI_CALENDAR_DATA_STREAM,] }, { type: core.Optional }] },
            ...
            { type: rxjs.Observable, decorators: [{ type: core.Inject, args: [tokens.TUI_OTHER_DATE_TEXT,] }] }
        ]; };
        __decorate([
            core.Input(),
            cdk.tuiDefaultProp()
        ...
        TuiCalendarRangeComponent = __decorate([
            ...
            __param(0, core.Inject(tokens.TUI_CALENDAR_DATA_STREAM)),
            __param(0, core.Optional()),
            __param(1, core.Inject(core.ChangeDetectorRef)),
            __param(2, core.Inject(cdk.TuiDestroyService)),
            __param(3, core.Inject(tokens.TUI_OTHER_DATE_TEXT))
        ...
        TuiCalendarRangeModule = __decorate([
            core.NgModule({
                imports: [
                    ...
                    core$1.TuiCalendarModule,
                    core$1.TuiCalendarModule,
                    core$1.TuiSvgModule,
                    core$1.TuiDataListModule,
                    primitiveCalendarRange.TuiPrimitiveCalendarRangeModule,
                ],
