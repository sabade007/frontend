(function (global, factory) {
    ...
    (global = global || self, factory((global['taiga-ui'] = global['taiga-ui'] || {}, global['taiga-ui'].kit = global['taiga-ui'].kit || {}, global['taiga-ui'].kit.components = global['taiga-ui'].kit.components || {}, global['taiga-ui'].kit.components['select-option'] = {}), global.ng.core, global.ng.forms, global.cdk, global.core$1, global.ngPolymorpheus, global.rxjs, global.rxjs.operators, global.ng.common));
}(this, (function (exports, core, forms, cdk, core$1, ngPolymorpheus, rxjs, operators, common) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var TuiSelectOptionComponent = /** @class */ (function () {
        function TuiSelectOptionComponent(context, host, elementRef, option, control) {
            ...
            this.selected$ = rxjs.merge((_a = this.control.valueChanges) !== null && _a !== void 0 ? _a : rxjs.EMPTY, cdk.typedFromEvent(this.elementRef.nativeElement, 'animationstart')).pipe(operators.startWith(null), operators.map(function () { return _this.selected; }), operators.distinctUntilChanged());
        }
        ...
        TuiSelectOptionComponent.prototype.ngOnInit = function () {
            ...
            Promise.resolve().then(function () {
                if (cdk.isPresent(_this.option.value) && _this.host.checkOption) {
        ...
        Object.defineProperty(TuiSelectOptionComponent.prototype, "selected", {
            get: function () {
                return (cdk.isPresent(this.option.value) &&
                    cdk.isPresent(this.control.value) &&
        ...
        TuiSelectOptionComponent.ctorParameters = function () { return [
            ...
            { type: core$1.TuiOptionComponent, decorators: [{ type: core.Inject, args: [core$1.TuiOptionComponent,] }] },
        ...
        TuiSelectOptionComponent = __decorate([
            ...
            __param(1, core.Inject(core$1.TUI_DATA_LIST_HOST)),
            __param(2, core.Inject(core.ElementRef)),
            __param(3, core.Inject(core$1.TuiOptionComponent)),
            __param(4, core.Inject(forms.NgControl))
    ...
    var TuiSelectOptionModule = /** @class */ (function () {
        ...
        TuiSelectOptionModule = __decorate([
            core.NgModule({
                imports: [common.CommonModule, core$1.TuiSvgModule, core$1.TuiScrollIntoViewModule],
