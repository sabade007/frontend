(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@taiga-ui/cdk'), require('@taiga-ui/core/abstract'), require('@taiga-ui/core/directives/described-by'), require('@taiga-ui/core/services'), require('rxjs'), require('rxjs/operators')) :
    typeof define === 'function' && define.amd ? define('@taiga-ui/core/directives/hint', ['exports', '@angular/core', '@taiga-ui/cdk', '@taiga-ui/core/abstract', '@taiga-ui/core/directives/described-by', '@taiga-ui/core/services', 'rxjs', 'rxjs/operators'], factory) :
    (global = global || self, factory((global['taiga-ui'] = global['taiga-ui'] || {}, global['taiga-ui'].core = global['taiga-ui'].core || {}, global['taiga-ui'].core.directives = global['taiga-ui'].core.directives || {}, global['taiga-ui'].core.directives.hint = {}), global.ng.core, global.cdk, global['taiga-ui'].core.abstract, global['taiga-ui'].core.directives['described-by'], global['taiga-ui'].core.services, global.rxjs, global.rxjs.operators));
}(this, (function (exports, core, cdk, abstract, describedBy, services, rxjs, operators) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var TUI_HINT_DEFAULT_OPTIONS = __assign(__assign({}, abstract.TUI_ABSTRACT_HINT_DEFAULT_OPTIONS), { tuiHintShowDelay: 500, tuiHintHideDelay: 200, tooltipIcon: TUI_TOOLTIP_ICON });
    var TUI_HINT_OPTIONS = new core.InjectionToken("Default parameters for hint directive", {
    ...
    var TuiHintDirective = /** @class */ (function (_super) {
        ...
        function TuiHintDirective(renderer, elementRef, hintService, destroy$, obscured$, hoveredService, activeZone, options) {
            ...
            _this.componentHovered$ = new rxjs.Subject();
            // @bad TODO: Use private provider
            rxjs.combineLatest(hoveredService.createHovered$(elementRef.nativeElement), _this.componentHovered$.pipe(operators.startWith(false)))
                .pipe(operators.map(function (_a) {
                var _b = __read(_a, 2), directiveHovered = _b[0], componentHovered = _b[1];
                return directiveHovered || componentHovered;
            }), operators.switchMap(function (visible) {
                _this.toggleClass(visible);
                return rxjs.of(visible).pipe(operators.delay(visible ? _this.tuiHintShowDelay : _this.tuiHintHideDelay));
            }), operators.switchMap(function (visible) {
                return visible && _this.mode !== 'overflow'
                    ? obscured$.pipe(operators.map(function (obscured) { return !obscured; }), operators.take(2))
                    : rxjs.of(visible);
        ...
        Object.defineProperty(TuiHintDirective.prototype, "id", {
            get: function () {
                return this.tuiHintId ? this.tuiHintId + describedBy.DESCRIBED_BY : null;
            },
            enumerable: true,
            configurable: true
        });
        ...
        TuiHintDirective.ctorParameters = function () { return [
            ...
            { type: cdk.TuiObscuredService, decorators: [{ type: core.Inject, args: [cdk.TuiObscuredService,] }, { type: core.Self }] },
            { type: cdk.TuiHoveredService, decorators: [{ type: core.Inject, args: [cdk.TuiHoveredService,] }] },
            { type: cdk.TuiActiveZoneDirective, decorators: [{ type: core.Optional }, { type: core.Inject, args: [cdk.TuiActiveZoneDirective,] }] },
            { type: undefined, decorators: [{ type: core.Inject, args: [TUI_HINT_OPTIONS,] }] }
        ]; };
        __decorate([
            core.Input()
        ...
        TuiHintDirective = __decorate([
            core.Directive({
                ...
                providers: [cdk.TuiObscuredService, cdk.TuiParentsScrollService, cdk.TuiDestroyService],
            }),
            __param(0, core.Inject(core.Renderer2)),
            __param(1, core.Inject(core.ElementRef)),
            __param(2, core.Inject(services.TuiHintService)),
            __param(3, core.Inject(cdk.TuiDestroyService)),
            __param(4, core.Inject(cdk.TuiObscuredService)),
            __param(4, core.Self()),
            __param(5, core.Inject(cdk.TuiHoveredService)),
            __param(6, core.Optional()),
            __param(6, core.Inject(cdk.TuiActiveZoneDirective)),
            __param(7, core.Inject(TUI_HINT_OPTIONS))
        ], TuiHintDirective);
        return TuiHintDirective;
    }(abstract.AbstractTuiHint));
