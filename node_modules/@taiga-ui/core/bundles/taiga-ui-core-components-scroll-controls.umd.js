(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@ng-web-apis/common'), require('@taiga-ui/cdk'), require('@taiga-ui/core/animations'), require('@taiga-ui/core/providers'), require('@taiga-ui/core/tokens'), require('rxjs'), require('rxjs/operators'), require('@angular/common')) :
    typeof define === 'function' && define.amd ? define('@taiga-ui/core/components/scroll-controls', ['exports', '@angular/core', '@ng-web-apis/common', '@taiga-ui/cdk', '@taiga-ui/core/animations', '@taiga-ui/core/providers', '@taiga-ui/core/tokens', 'rxjs', 'rxjs/operators', '@angular/common'], factory) :
    (global = global || self, factory((global['taiga-ui'] = global['taiga-ui'] || {}, global['taiga-ui'].core = global['taiga-ui'].core || {}, global['taiga-ui'].core.components = global['taiga-ui'].core.components || {}, global['taiga-ui'].core.components['scroll-controls'] = {}), global.ng.core, global.common, global.cdk, global['taiga-ui'].core.animations, global['taiga-ui'].core.providers, global['taiga-ui'].core.tokens, global.rxjs, global.rxjs.operators, global.ng.common));
}(this, (function (exports, core, common, cdk, animations, providers, tokens, rxjs, operators, common$1) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var TuiScrollControlsComponent = /** @class */ (function () {
        ...
        TuiScrollControlsComponent.ctorParameters = function () { return [
            ...
            { type: core.ElementRef, decorators: [{ type: core.Inject, args: [tokens.TUI_SCROLL_REF,] }] },
        ...
        TuiScrollControlsComponent = __decorate([
            ...
            __param(2, core.Inject(tokens.TUI_SCROLL_REF)),
            __param(3, core.Inject(common.ANIMATION_FRAME)),
            __param(4, core.Inject(tokens.TUI_MODE))
    ...
    var TuiScrollbarDirective = /** @class */ (function () {
        function TuiScrollbarDirective(ngZone, renderer, destroy$, animationFrame$, wrapper, container, doc, el) {
            ...
            rxjs.merge(mousedownWrapper$.pipe(cdk.tuiPreventDefault(), operators.map(function (event) { return _this.getScrolled(event, 0.5, 0.5); })), mousedown$.pipe(cdk.tuiPreventDefault(), cdk.tuiStopPropagation(), operators.switchMap(function (event) {
            ...
            rxjs.merge(animationFrame$.pipe(operators.throttleTime(cdk.POLLING_TIME)), cdk.tuiScrollFrom(this.element))
                .pipe(cdk.tuiZonefree(ngZone), operators.takeUntil(destroy$))
                .subscribe(function () {
                if (_this.tuiScrollbar === 'vertical') {
        ...
        TuiScrollbarDirective.ctorParameters = function () { return [
            ...
            { type: rxjs.Observable, decorators: [{ type: core.Self }, { type: core.Inject, args: [cdk.TuiDestroyService,] }] },
            { type: rxjs.Observable, decorators: [{ type: core.Inject, args: [common.ANIMATION_FRAME,] }] },
            { type: core.ElementRef, decorators: [{ type: core.Inject, args: [tokens.TUI_ELEMENT_REF,] }] },
            { type: core.ElementRef, decorators: [{ type: core.Inject, args: [tokens.TUI_SCROLL_REF,] }] },
            { type: Document, decorators: [{ type: core.Inject, args: [common$1.DOCUMENT,] }] },
        ...
        TuiScrollbarDirective = __decorate([
            ...
            __param(2, core.Self()), __param(2, core.Inject(cdk.TuiDestroyService)),
            __param(3, core.Inject(common.ANIMATION_FRAME)),
            __param(4, core.Inject(tokens.TUI_ELEMENT_REF)),
            __param(5, core.Inject(tokens.TUI_SCROLL_REF)),
            __param(6, core.Inject(common$1.DOCUMENT)),
    ...
    var TuiScrollControlsModule = /** @class */ (function () {
        ...
        TuiScrollControlsModule = __decorate([
            core.NgModule({
                imports: [common$1.CommonModule, cdk.TuiLetModule],
                declarations: [
                    TuiScrollbarDirective,
                    TuiScrollbarWrapperDirective,
                    TuiScrollControlsComponent,
    ...
    exports.ɵa = TuiScrollbarWrapperDirective;
