(function (global, factory) {
...
}(this, (function (exports, core, cdk, svg, wrapper, ngPolymorpheus) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var TUI_CHECKBOX_OPTIONS = new core.InjectionToken("Default parameters for checkbox component", {
    ...
    var tuiCheckboxOptionsProvider = function (options) { return ({
        ...
        useValue: __assign(__assign({}, TUI_CHECKBOX_DEFAULT_OPTIONS), options),
    }); };
    ...
    var TuiPrimitiveCheckboxComponent = /** @class */ (function () {
        ...
        TuiPrimitiveCheckboxComponent.ctorParameters = function () { return [
            { type: undefined, decorators: [{ type: core.Inject, args: [TUI_CHECKBOX_OPTIONS,] }] }
        ]; };
        __decorate([
            core.Input(),
        ...
        TuiPrimitiveCheckboxComponent = __decorate([
            ...
            __param(0, core.Inject(TUI_CHECKBOX_OPTIONS))
    ...
    var TuiPrimitiveCheckboxModule = /** @class */ (function () {
        ...
        TuiPrimitiveCheckboxModule = __decorate([
            core.NgModule({
                imports: [svg.TuiSvgModule, wrapper.TuiWrapperModule, ngPolymorpheus.PolymorpheusModule],
