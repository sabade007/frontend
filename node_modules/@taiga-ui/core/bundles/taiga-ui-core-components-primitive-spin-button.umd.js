(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@taiga-ui/cdk'), require('@taiga-ui/core/tokens'), require('rxjs'), require('@angular/common'), require('@taiga-ui/core/components/button')) :
    typeof define === 'function' && define.amd ? define('@taiga-ui/core/components/primitive-spin-button', ['exports', '@angular/core', '@taiga-ui/cdk', '@taiga-ui/core/tokens', 'rxjs', '@angular/common', '@taiga-ui/core/components/button'], factory) :
    (global = global || self, factory((global['taiga-ui'] = global['taiga-ui'] || {}, global['taiga-ui'].core = global['taiga-ui'].core || {}, global['taiga-ui'].core.components = global['taiga-ui'].core.components || {}, global['taiga-ui'].core.components['primitive-spin-button'] = {}), global.ng.core, global.cdk, global['taiga-ui'].core.tokens, global.rxjs, global.ng.common, global['taiga-ui'].core.components.button));
}(this, (function (exports, core, cdk, tokens, rxjs, common, button) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var TuiPrimitiveSpinButtonComponent = /** @class */ (function (_super) {
        ...
        function TuiPrimitiveSpinButtonComponent(spinTexts$) {
            ...
            _this.leftClick = new core.EventEmitter();
            _this.rightClick = new core.EventEmitter();
            return _this;
        }
        Object.defineProperty(TuiPrimitiveSpinButtonComponent.prototype, "focused", {
            get: function () {
                return !!this.wrapper && cdk.isNativeFocused(this.wrapper.nativeElement);
            },
            enumerable: true,
            configurable: true
        });
        ...
        TuiPrimitiveSpinButtonComponent.ctorParameters = function () { return [
            { type: rxjs.Observable, decorators: [{ type: core.Inject, args: [tokens.TUI_SPIN_TEXTS,] }] }
        ]; };
        __decorate([
        ...
        TuiPrimitiveSpinButtonComponent = __decorate([
            ...
            __param(0, core.Inject(tokens.TUI_SPIN_TEXTS))
