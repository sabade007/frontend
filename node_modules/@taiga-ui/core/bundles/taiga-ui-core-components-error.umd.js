(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@taiga-ui/cdk'), require('@taiga-ui/core/animations'), require('@taiga-ui/core/providers'), require('@taiga-ui/core/tokens'), require('rxjs'), require('@angular/common'), require('@tinkoff/ng-polymorpheus')) :
    typeof define === 'function' && define.amd ? define('@taiga-ui/core/components/error', ['exports', '@angular/core', '@taiga-ui/cdk', '@taiga-ui/core/animations', '@taiga-ui/core/providers', '@taiga-ui/core/tokens', 'rxjs', '@angular/common', '@tinkoff/ng-polymorpheus'], factory) :
    (global = global || self, factory((global['taiga-ui'] = global['taiga-ui'] || {}, global['taiga-ui'].core = global['taiga-ui'].core || {}, global['taiga-ui'].core.components = global['taiga-ui'].core.components || {}, global['taiga-ui'].core.components.error = {}), global.ng.core, global.cdk, global['taiga-ui'].core.animations, global['taiga-ui'].core.providers, global['taiga-ui'].core.tokens, global.rxjs, global.ng.common, global.ngPolymorpheus));
}(this, (function (exports, core, cdk, animations, providers, tokens, rxjs, common, ngPolymorpheus) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var TuiErrorComponent = /** @class */ (function () {
        ...
        Object.defineProperty(TuiErrorComponent.prototype, "errorSetter", {
            set: function (error) {
                this.error = typeof error === 'string' ? new cdk.TuiValidationError(error) : error;
            },
            enumerable: true,
            configurable: true
        });
        TuiErrorComponent.ctorParameters = function () { return [
            ...
            { type: rxjs.Observable, decorators: [{ type: core.Inject, args: [tokens.TUI_DEFAULT_ERROR_MESSAGE,] }] }
        ]; };
        __decorate([
            core.Input('error'),
            cdk.tuiDefaultProp()
        ...
        TuiErrorComponent = __decorate([
            ...
            __param(2, core.Inject(tokens.TUI_DEFAULT_ERROR_MESSAGE))
        ], TuiErrorComponent);
    ...
    var TuiErrorModule = /** @class */ (function () {
        ...
        TuiErrorModule = __decorate([
            core.NgModule({
                imports: [common.CommonModule, ngPolymorpheus.PolymorpheusModule],
