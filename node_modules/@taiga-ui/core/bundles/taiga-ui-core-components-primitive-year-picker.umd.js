(function (global, factory) {
    ...
    (global = global || self, factory((global['taiga-ui'] = global['taiga-ui'] || {}, global['taiga-ui'].core = global['taiga-ui'].core || {}, global['taiga-ui'].core.components = global['taiga-ui'].core.components || {}, global['taiga-ui'].core.components['primitive-year-picker'] = {}), global.ng.core, global.cdk, global['taiga-ui'].core.directives['scroll-into-view']));
}(this, (function (exports, core, cdk, scrollIntoView) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var TuiPrimitiveYearPickerComponent = /** @class */ (function () {
        function TuiPrimitiveYearPickerComponent() {
            ...
            this.currentYear = cdk.TuiMonth.currentLocal().year;
            this.value = null;
            this.initialItem = cdk.TuiMonth.currentLocal();
        ...
        TuiPrimitiveYearPickerComponent.prototype.isRange = function (item) {
            return item instanceof cdk.TuiMonthRange;
        };
        ...
        TuiPrimitiveYearPickerComponent.prototype.getItemState = function (item) {
            ...
            if (max.year < item ||
                (disabledItemHandler !== cdk.ALWAYS_FALSE_HANDLER && disabledItemHandler(item))) {
        ...
        TuiPrimitiveYearPickerComponent.prototype.getItemRange = function (item) {
            ...
            if (value instanceof cdk.TuiYear) {
        ...
        TuiPrimitiveYearPickerComponent.prototype.itemIsInterval = function (item) {
            ...
            return cdk.inRange(item, Math.min(value.from.year, hoveredItem), Math.max(value.from.year, hoveredItem));
        };
        ...
        TuiPrimitiveYearPickerComponent.prototype.onItemClick = function (item) {
            this.yearClick.emit(new cdk.TuiYear(item));
        };
        ...
        TuiPrimitiveYearPickerModule = __decorate([
            core.NgModule({
                imports: [
                    ...
                    cdk.TuiLetModule,
                    scrollIntoView.TuiScrollIntoViewModule,
                ],
