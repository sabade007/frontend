(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@taiga-ui/core/tokens'), require('@taiga-ui/i18n')) :
    typeof define === 'function' && define.amd ? define('@taiga-ui/core/pipes/flag', ['exports', '@angular/core', '@taiga-ui/core/tokens', '@taiga-ui/i18n'], factory) :
    (global = global || self, factory((global['taiga-ui'] = global['taiga-ui'] || {}, global['taiga-ui'].core = global['taiga-ui'].core || {}, global['taiga-ui'].core.pipes = global['taiga-ui'].core.pipes || {}, global['taiga-ui'].core.pipes.flag = {}), global.ng.core, global['taiga-ui'].core.tokens, global.i18n));
}(this, (function (exports, core, tokens, i18n) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var TuiFlagPipe = /** @class */ (function () {
        ...
        TuiFlagPipe = __decorate([
            core.Pipe({ name: "tuiFlag" }),
            __param(0, core.Inject(tokens.TUI_ICONS_PATH))
        ], TuiFlagPipe);
        return TuiFlagPipe;
    }());
