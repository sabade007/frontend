(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@taiga-ui/cdk'), require('@taiga-ui/core/providers'), require('@taiga-ui/core/tokens'), require('rxjs'), require('rxjs/operators'), require('@angular/common'), require('@taiga-ui/core/components/svg')) :
    typeof define === 'function' && define.amd ? define('@taiga-ui/core/components/link', ['exports', '@angular/core', '@taiga-ui/cdk', '@taiga-ui/core/providers', '@taiga-ui/core/tokens', 'rxjs', 'rxjs/operators', '@angular/common', '@taiga-ui/core/components/svg'], factory) :
    (global = global || self, factory((global['taiga-ui'] = global['taiga-ui'] || {}, global['taiga-ui'].core = global['taiga-ui'].core || {}, global['taiga-ui'].core.components = global['taiga-ui'].core.components || {}, global['taiga-ui'].core.components.link = {}), global.ng.core, global.cdk, global['taiga-ui'].core.providers, global['taiga-ui'].core.tokens, global.rxjs, global.rxjs.operators, global.ng.common, global['taiga-ui'].core.components.svg));
}(this, (function (exports, core, cdk, providers, tokens, rxjs, operators, common, svg) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var TuiLinkComponent = /** @class */ (function () {
        function TuiLinkComponent(elementRef, mode$, focusVisible$) {
            ...
            this.focusedChange = rxjs.merge(cdk.typedFromEvent(this.elementRef.nativeElement, 'focusin').pipe(operators.mapTo(true)), cdk.typedFromEvent(this.elementRef.nativeElement, 'focusout').pipe(operators.mapTo(false)));
        ...
        __decorate([
            core.Input(),
            core.HostBinding('class._pseudo'),
            cdk.tuiDefaultProp()
        ...
        __decorate([
            core.Input(),
            core.HostBinding('class._icon-rotated'),
            cdk.tuiDefaultProp()
        ], TuiLinkComponent.prototype, "iconRotated", void 0);
        __decorate([
            core.Input(),
            core.HostBinding('attr.data-host-mode'),
            cdk.tuiDefaultProp()
                ...
                providers: [
                    {
                        ...
                        useExisting: core.forwardRef(function () { return TuiLinkComponent_1; }),
                    },
    ...
    var TuiLinkModule = /** @class */ (function () {
        ...
        TuiLinkModule = __decorate([
            core.NgModule({
                imports: [common.CommonModule, svg.TuiSvgModule],
    ...
    exports.TuiLinkComponent = TuiLinkComponent;
    exports.TuiLinkModule = TuiLinkModule;

    Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=taiga-ui-core-components-link.umd.js.map
