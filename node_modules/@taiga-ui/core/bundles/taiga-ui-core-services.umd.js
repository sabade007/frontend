(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('rxjs'), require('@ng-web-apis/common'), require('rxjs/operators'), require('@angular/router'), require('@taiga-ui/cdk'), require('@angular/platform-browser'), require('@taiga-ui/core/tokens'), require('@taiga-ui/core/utils/dom')) :
    typeof define === 'function' && define.amd ? define('@taiga-ui/core/services', ['exports', '@angular/core', 'rxjs', '@ng-web-apis/common', 'rxjs/operators', '@angular/router', '@taiga-ui/cdk', '@angular/platform-browser', '@taiga-ui/core/tokens', '@taiga-ui/core/utils/dom'], factory) :
    (global = global || self, factory((global['taiga-ui'] = global['taiga-ui'] || {}, global['taiga-ui'].core = global['taiga-ui'].core || {}, global['taiga-ui'].core.services = {}), global.ng.core, global.rxjs, global.common, global.rxjs.operators, global.ng.router, global.cdk, global.ng.platformBrowser, global['taiga-ui'].core.tokens, global['taiga-ui'].core.utils.dom));
}(this, (function (exports, core, rxjs, common, operators, router, cdk, platformBrowser, tokens, dom) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var TuiFormatDateService = /** @class */ (function () {
        ...
        TuiFormatDateService.prototype.format = function (timestamp) {
            return rxjs.of(new Date(timestamp).toLocaleTimeString(this.locale, {
                hour: "numeric",
                minute: "2-digit",
            }));
        };
        ...
        TuiFormatDateService.ɵprov = core.ɵɵdefineInjectable({ factory: function TuiFormatDateService_Factory() { return new TuiFormatDateService(core.ɵɵinject(core.LOCALE_ID)); }, token: TuiFormatDateService, providedIn: "root" });
    ...
    var TuiHintService = /** @class */ (function (_super) {
        ...
        TuiHintService.ɵprov = core.ɵɵdefineInjectable({ factory: function TuiHintService_Factory() { return new TuiHintService(); }, token: TuiHintService, providedIn: "root" });
    ...
    var TuiNightThemeService = /** @class */ (function (_super) {
        ...
        function TuiNightThemeService(windowRef) {
            ...
            var media$ = rxjs.fromEvent(media, "change").pipe(operators.startWith(null), operators.map(function () { return media.matches; }), operators.share());
        ...
        TuiNightThemeService.ɵprov = core.ɵɵdefineInjectable({ factory: function TuiNightThemeService_Factory() { return new TuiNightThemeService(core.ɵɵinject(common.WINDOW)); }, token: TuiNightThemeService, providedIn: "root" });
        TuiNightThemeService = __decorate([
            core.Injectable({
                providedIn: "root",
            }),
            __param(0, core.Inject(common.WINDOW))
    ...
    var TuiRouterLinkActiveService = /** @class */ (function (_super) {
        ...
        function TuiRouterLinkActiveService(routerLinkActive, ngZone, animationFrame$, destroy$) {
            ...
            var stream$ = routerLinkActive
                ? animationFrame$.pipe(operators.map(function () { return routerLinkActive.isActive; }), operators.distinctUntilChanged(), cdk.tuiZoneOptimized(ngZone), operators.takeUntil(destroy$))
                : rxjs.EMPTY;
    ...
    var TuiSvgService = /** @class */ (function () {
        function TuiSvgService(tuiSanitizer, sanitizer, icons) {
            ...
            this.originals = {};
            this.items$ = new rxjs.BehaviorSubject(new Map());
            this.define(icons);
        }
        ...
        TuiSvgService.prototype.defineIcon = function (name, src, map) {
            ...
            if (!parsed) {
                cdk.tuiAssert.assert(false, "Unable to parse given SVG src");
                return;
            }
            map.set(name, parsed);
        ...
        TuiSvgService.prototype.parseSrc = function (name, src) {
            return this.sanitize(dom.processIcon(src, name));
        };
        TuiSvgService.prototype.sanitize = function (src) {
            return this.sanitizer.bypassSecurityTrustHtml((this.tuiSanitizer
                ? this.tuiSanitizer.sanitize(core.SecurityContext.HTML, src)
                : this.sanitizer.sanitize(core.SecurityContext.HTML, src)) || "");
        };
        TuiSvgService.ctorParameters = function () { return [
            { type: core.Sanitizer, decorators: [{ type: core.Optional }, { type: core.Inject, args: [tokens.TUI_SANITIZER,] }] },
            { type: platformBrowser.DomSanitizer, decorators: [{ type: core.Inject, args: [platformBrowser.DomSanitizer,] }] },
            { type: undefined, decorators: [{ type: core.Inject, args: [tokens.TUI_ICONS,] }] }
        ]; };
        TuiSvgService.ɵprov = core.ɵɵdefineInjectable({ factory: function TuiSvgService_Factory() { return new TuiSvgService(core.ɵɵinject(tokens.TUI_SANITIZER, 8), core.ɵɵinject(platformBrowser.DomSanitizer), core.ɵɵinject(tokens.TUI_ICONS)); }, token: TuiSvgService, providedIn: "root" });
        TuiSvgService = __decorate([
            core.Injectable({
                providedIn: "root",
            }),
            __param(0, core.Optional()),
            __param(0, core.Inject(tokens.TUI_SANITIZER)),
            __param(1, core.Inject(platformBrowser.DomSanitizer)),
            __param(2, core.Inject(tokens.TUI_ICONS))
        ], TuiSvgService);
