(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/common'), require('@angular/core'), require('@taiga-ui/cdk'), require('@taiga-ui/core/constants'), require('rxjs'), require('rxjs/operators')) :
    typeof define === 'function' && define.amd ? define('@taiga-ui/core/directives/scroll-into-view', ['exports', '@angular/common', '@angular/core', '@taiga-ui/cdk', '@taiga-ui/core/constants', 'rxjs', 'rxjs/operators'], factory) :
    (global = global || self, factory((global['taiga-ui'] = global['taiga-ui'] || {}, global['taiga-ui'].core = global['taiga-ui'].core || {}, global['taiga-ui'].core.directives = global['taiga-ui'].core.directives || {}, global['taiga-ui'].core.directives['scroll-into-view'] = {}), global.ng.common, global.ng.core, global.cdk, global['taiga-ui'].core.constants, global.rxjs, global.rxjs.operators));
}(this, (function (exports, common, core, cdk, constants, rxjs, operators) { 'use strict';
        ...
        Object.defineProperty(TuiScrollIntoViewDirective.prototype, "tuiScrollIntoView", {
            set: function (scroll) {
                ...
                rxjs.timer(0)
                    ...
                    .subscribe(function () {
                    _this.elementRef.nativeElement.dispatchEvent(cdk.tuiCustomEvent(constants.TUI_SCROLL_INTO_VIEW, {
                        bubbles: true,
