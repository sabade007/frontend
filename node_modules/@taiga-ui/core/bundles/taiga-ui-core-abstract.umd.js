(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@taiga-ui/cdk'), require('@taiga-ui/core/components/dropdown-box'), require('@taiga-ui/core/constants'), require('@taiga-ui/core/utils/dom'), require('@taiga-ui/core/services')) :
    typeof define === 'function' && define.amd ? define('@taiga-ui/core/abstract', ['exports', '@angular/core', '@taiga-ui/cdk', '@taiga-ui/core/components/dropdown-box', '@taiga-ui/core/constants', '@taiga-ui/core/utils/dom', '@taiga-ui/core/services'], factory) :
    (global = global || self, factory((global['taiga-ui'] = global['taiga-ui'] || {}, global['taiga-ui'].core = global['taiga-ui'].core || {}, global['taiga-ui'].core.abstract = {}), global.ng.core, global.cdk, global['taiga-ui'].core.components['dropdown-box'], global['taiga-ui'].core.constants, global['taiga-ui'].core.utils.dom, global['taiga-ui'].core.services));
}(this, (function (exports, core, cdk, dropdownBox, constants, dom, services) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var AbstractTuiDropdown = /** @class */ (function () {
        function AbstractTuiDropdown(componentFactoryResolver, injector, portalService, elementRef, activeZone) {
            ...
            this.minHeight = constants.DEFAULT_MIN_HEIGHT;
            this.maxHeight = constants.DEFAULT_MAX_HEIGHT;
            this.align = "left";
            this.direction = null;
            this.sided = false;
        ...
        Object.defineProperty(AbstractTuiDropdown.prototype, "fixed", {
            get: function () {
                return dom.checkFixedPosition(this.elementRef.nativeElement);
            },
            enumerable: true,
            configurable: true
        });
        ...
        AbstractTuiDropdown.prototype.openDropdownBox = function () {
            ...
            var componentFactory = this.componentFactoryResolver.resolveComponentFactory(dropdownBox.TuiDropdownBoxComponent);
        ...
        AbstractTuiDropdown.ctorParameters = function () { return [
            ...
            { type: core.Injector },
            { type: cdk.TuiPortalService },
            { type: core.ElementRef },
            { type: cdk.TuiActiveZoneDirective }
        ]; };
        __decorate([
            core.Input("tuiDropdownContent"),
            cdk.tuiDefaultProp()
        ], AbstractTuiDropdown.prototype, "content", void 0);
        __decorate([
            core.Input("tuiDropdownHost"),
            cdk.tuiDefaultProp()
    ...
    var TuiAbstractTextfieldHost = /** @class */ (function () {
        ...
        TuiAbstractTextfieldHost.ctorParameters = function () { return [
            { type: undefined, decorators: [{ type: core.Inject, args: [cdk.AbstractTuiControl,] }] }
        ]; };
    ...
    exports.AbstractTuiDropdown = AbstractTuiDropdown;
    exports.AbstractTuiHint = AbstractTuiHint;
    exports.TUI_ABSTRACT_HINT_DEFAULT_OPTIONS = TUI_ABSTRACT_HINT_DEFAULT_OPTIONS;
    exports.TuiAbstractTextfieldHost = TuiAbstractTextfieldHost;
