(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@taiga-ui/cdk'), require('@taiga-ui/core/tokens'), require('rxjs'), require('@angular/common'), require('@taiga-ui/core/components/button'), require('@taiga-ui/core/components/svg')) :
    typeof define === 'function' && define.amd ? define('@taiga-ui/core/components/notification', ['exports', '@angular/core', '@taiga-ui/cdk', '@taiga-ui/core/tokens', 'rxjs', '@angular/common', '@taiga-ui/core/components/button', '@taiga-ui/core/components/svg'], factory) :
    (global = global || self, factory((global['taiga-ui'] = global['taiga-ui'] || {}, global['taiga-ui'].core = global['taiga-ui'].core || {}, global['taiga-ui'].core.components = global['taiga-ui'].core.components || {}, global['taiga-ui'].core.components.notification = {}), global.ng.core, global.cdk, global['taiga-ui'].core.tokens, global.rxjs, global.ng.common, global['taiga-ui'].core.components.button, global['taiga-ui'].core.components.svg));
}(this, (function (exports, core, cdk, tokens, rxjs, common, button, svg) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var TuiNotificationComponent = /** @class */ (function () {
        ...
        TuiNotificationComponent.ctorParameters = function () { return [
            { type: rxjs.Observable, decorators: [{ type: core.Inject, args: [tokens.TUI_CLOSE_WORD,] }] },
            { type: undefined, decorators: [{ type: core.Inject, args: [tokens.TUI_NOTIFICATION_OPTIONS,] }] }
        ]; };
        __decorate([
            core.Input(),
            core.HostBinding('class._has-icon'),
            cdk.tuiDefaultProp()
        ], TuiNotificationComponent.prototype, "hasIcon", void 0);
        __decorate([
            core.Input(),
            core.HostBinding('attr.data-tui-host-status'),
            cdk.tuiDefaultProp()
        ...
        __decorate([
            core.HostBinding('class._has-close-button')
        ...
        TuiNotificationComponent = __decorate([
            ...
            __param(0, core.Inject(tokens.TUI_CLOSE_WORD)),
            __param(1, core.Inject(tokens.TUI_NOTIFICATION_OPTIONS))
    ...
    var TuiNotificationModule = /** @class */ (function () {
        ...
        TuiNotificationModule = __decorate([
            core.NgModule({
                imports: [common.CommonModule, svg.TuiSvgModule, button.TuiButtonModule],
