(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@taiga-ui/cdk'), require('@taiga-ui/core/constants'), require('@angular/common'), require('@taiga-ui/core/components/loader')) :
    typeof define === 'function' && define.amd ? define('@taiga-ui/core/components/expand', ['exports', '@angular/core', '@taiga-ui/cdk', '@taiga-ui/core/constants', '@angular/common', '@taiga-ui/core/components/loader'], factory) :
    (global = global || self, factory((global['taiga-ui'] = global['taiga-ui'] || {}, global['taiga-ui'].core = global['taiga-ui'].core || {}, global['taiga-ui'].core.components = global['taiga-ui'].core.components || {}, global['taiga-ui'].core.components.expand = {}), global.ng.core, global.cdk, global['taiga-ui'].core.constants, global.ng.common, global['taiga-ui'].core.components.loader));
}(this, (function (exports, core, cdk, constants, common, loader) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var TuiExpandComponent = /** @class */ (function () {
        ...
        __decorate([
            core.ContentChild(TuiExpandContentDirective, { read: core.TemplateRef })
        ], TuiExpandComponent.prototype, "content", void 0);
        __decorate([
            core.HostBinding('class._expanded'),
            core.HostBinding('attr.aria-expanded')
        ], TuiExpandComponent.prototype, "expanded", void 0);
        __decorate([
            core.HostBinding('class._overflow')
        ...
        __decorate([
            core.HostListener(constants.TUI_EXPAND_LOADED, ['$event'])
    ...
    var TuiExpandModule = /** @class */ (function () {
        ...
        TuiExpandModule = __decorate([
            core.NgModule({
                imports: [common.CommonModule, loader.TuiLoaderModule],
