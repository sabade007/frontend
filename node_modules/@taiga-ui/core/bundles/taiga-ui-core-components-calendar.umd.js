(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@taiga-ui/cdk'), require('@taiga-ui/core/constants'), require('@angular/common'), require('@taiga-ui/core/components/primitive-calendar'), require('@taiga-ui/core/components/primitive-year-picker'), require('@taiga-ui/core/components/scrollbar'), require('@taiga-ui/core/internal/primitive-year-month-pagination')) :
    typeof define === 'function' && define.amd ? define('@taiga-ui/core/components/calendar', ['exports', '@angular/core', '@taiga-ui/cdk', '@taiga-ui/core/constants', '@angular/common', '@taiga-ui/core/components/primitive-calendar', '@taiga-ui/core/components/primitive-year-picker', '@taiga-ui/core/components/scrollbar', '@taiga-ui/core/internal/primitive-year-month-pagination'], factory) :
    (global = global || self, factory((global['taiga-ui'] = global['taiga-ui'] || {}, global['taiga-ui'].core = global['taiga-ui'].core || {}, global['taiga-ui'].core.components = global['taiga-ui'].core.components || {}, global['taiga-ui'].core.components.calendar = {}), global.ng.core, global.cdk, global['taiga-ui'].core.constants, global.ng.common, global['taiga-ui'].core.components['primitive-calendar'], global['taiga-ui'].core.components['primitive-year-picker'], global['taiga-ui'].core.components.scrollbar, global['taiga-ui'].core.internal['primitive-year-month-pagination']));
}(this, (function (exports, core, cdk, constants, common, primitiveCalendar, primitiveYearPicker, scrollbar, primitiveYearMonthPagination) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var TuiCalendarComponent = /** @class */ (function () {
        function TuiCalendarComponent() {
            ...
            this.minViewedMonth = cdk.TUI_FIRST_DAY;
            this.maxViewedMonth = cdk.TUI_LAST_DAY;
            this.hoveredItem = null;
            this.showAdjacent = true;
            this.markerHandler = constants.TUI_DEFAULT_MARKER_HANDLER;
            this.dayClick = new core.EventEmitter();
            this.monthChange = new core.EventEmitter();
            this.hoveredItemChange = new core.EventEmitter();
            this.year = null;
        ...
        TuiCalendarComponent.prototype.onPickerYearClick = function (_a) {
            var year = _a.year;
            this.year = null;
            this.updateViewedMonth(new cdk.TuiMonth(year, this.month.month));
        };
        ...
        TuiCalendarComponent.prototype.updateHoveredDay = function (day) {
            if (cdk.nullableSame(this.hoveredItem, day, function (a, b) { return a.daySame(b); })) {
                return;
            }
    ...
    var TuiCalendarModule = /** @class */ (function () {
        ...
        TuiCalendarModule = __decorate([
            core.NgModule({
                imports: [
                    common.CommonModule,
                    primitiveYearMonthPagination.TuiPrimitiveYearMonthPaginationModule,
                    primitiveCalendar.TuiPrimitiveCalendarModule,
                    primitiveYearPicker.TuiPrimitiveYearPickerModule,
                    scrollbar.TuiScrollbarModule,
