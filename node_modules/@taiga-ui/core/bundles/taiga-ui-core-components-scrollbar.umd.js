(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@taiga-ui/core/tokens'), require('@taiga-ui/core/constants'), require('@ng-web-apis/common'), require('@taiga-ui/cdk'), require('@angular/common'), require('@taiga-ui/core/components/scroll-controls')) :
    typeof define === 'function' && define.amd ? define('@taiga-ui/core/components/scrollbar', ['exports', '@angular/core', '@taiga-ui/core/tokens', '@taiga-ui/core/constants', '@ng-web-apis/common', '@taiga-ui/cdk', '@angular/common', '@taiga-ui/core/components/scroll-controls'], factory) :
    (global = global || self, factory((global['taiga-ui'] = global['taiga-ui'] || {}, global['taiga-ui'].core = global['taiga-ui'].core || {}, global['taiga-ui'].core.components = global['taiga-ui'].core.components || {}, global['taiga-ui'].core.components.scrollbar = {}), global.ng.core, global['taiga-ui'].core.tokens, global['taiga-ui'].core.constants, global.common, global.cdk, global.ng.common, global['taiga-ui'].core.components['scroll-controls']));
}(this, (function (exports, core, tokens, constants, common, cdk, common$1, scrollControls) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var TuiScrollableDirective = /** @class */ (function () {
        ...
        TuiScrollableDirective.prototype.ngOnInit = function () {
            this.elementRef.nativeElement.dispatchEvent(new CustomEvent(constants.TUI_SCROLLABLE, {
                bubbles: true,
    ...
    var TuiScrollbarComponent = /** @class */ (function () {
        function TuiScrollbarComponent(cssRef, elementRef, userAgent, isIos) {
            ...
            this.isLegacy = !this.cssRef.supports('position', 'sticky') ||
                (cdk.isFirefox(this.userAgent) && !this.cssRef.supports('scrollbar-width', 'none'));
            this.hidden = false;
            this.browserScrollRef = new core.ElementRef(this.elementRef.nativeElement);
        }
        ...
        TuiScrollbarComponent.prototype.scrollIntoView = function (detail) {
            ...
            var _a = cdk.getElementOffset(nativeElement, detail), offsetTop = _a.offsetTop, offsetLeft = _a.offsetLeft;
        ...
        TuiScrollbarComponent.ctorParameters = function () { return [
            { type: undefined, decorators: [{ type: core.Inject, args: [common.CSS,] }] },
            { type: core.ElementRef, decorators: [{ type: core.Inject, args: [core.ElementRef,] }] },
            { type: String, decorators: [{ type: core.Inject, args: [common.USER_AGENT,] }] },
        ...
        __decorate([
            core.HostBinding('class._legacy')
        ], TuiScrollbarComponent.prototype, "showNative", null);
        __decorate([
            core.HostListener(constants.TUI_SCROLLABLE + ".stop", ['$event.detail'])
        ], TuiScrollbarComponent.prototype, "onScrollable", null);
        __decorate([
            core.HostListener(constants.TUI_SCROLL_INTO_VIEW + ".stop", ['$event.detail'])
        ...
        TuiScrollbarComponent = TuiScrollbarComponent_1 = __decorate([
            ...
            __param(0, core.Inject(common.CSS)),
            __param(1, core.Inject(core.ElementRef)),
            __param(2, core.Inject(common.USER_AGENT)),
    ...
    var TuiScrollbarModule = /** @class */ (function () {
        ...
        TuiScrollbarModule = __decorate([
            core.NgModule({
                imports: [common$1.CommonModule, scrollControls.TuiScrollControlsModule],
    ...
    exports.scrollRefFactory = scrollRefFactory;
