(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@taiga-ui/cdk'), require('@taiga-ui/core/directives/dropdown'), require('@taiga-ui/core/directives/dropdown-controller'), require('@taiga-ui/core/utils/miscellaneous'), require('@angular/common'), require('@tinkoff/ng-polymorpheus')) :
    typeof define === 'function' && define.amd ? define('@taiga-ui/core/components/hosted-dropdown', ['exports', '@angular/core', '@taiga-ui/cdk', '@taiga-ui/core/directives/dropdown', '@taiga-ui/core/directives/dropdown-controller', '@taiga-ui/core/utils/miscellaneous', '@angular/common', '@tinkoff/ng-polymorpheus'], factory) :
    (global = global || self, factory((global['taiga-ui'] = global['taiga-ui'] || {}, global['taiga-ui'].core = global['taiga-ui'].core || {}, global['taiga-ui'].core.components = global['taiga-ui'].core.components || {}, global['taiga-ui'].core.components['hosted-dropdown'] = {}), global.ng.core, global.cdk, global['taiga-ui'].core.directives.dropdown, global['taiga-ui'].core.directives['dropdown-controller'], global['taiga-ui'].core.utils.miscellaneous, global.ng.common, global.ngPolymorpheus));
}(this, (function (exports, core, cdk, dropdown, dropdownController, miscellaneous, common, ngPolymorpheus) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var TuiHostedDropdownComponent = /** @class */ (function () {
        ...
        Object.defineProperty(TuiHostedDropdownComponent.prototype, "nativeFocusableElement", {
            get: function () {
                return cdk.isNativeKeyboardFocusable(this.host)
                    ? this.host
                    : cdk.getClosestFocusable(this.host, false, this.elementRef.nativeElement);
            },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(TuiHostedDropdownComponent.prototype, "focused", {
            get: function () {
                return (cdk.isNativeFocusedIn(this.host) ||
                    (this.open && !!this.wrapper && cdk.isNativeFocusedIn(this.wrapper.nativeElement)));
            },
            enumerable: true,
            configurable: true
        });
        ...
        TuiHostedDropdownComponent.prototype.onKeydown = function (_a) {
            ...
            if (!defaultPrevented &&
                miscellaneous.isEditingKey(key) &&
                this.hostEditable &&
                // TODO: iframe warning
                target instanceof HTMLElement &&
                !cdk.isElementEditable(target)) {
                this.focusHost();
            }
        };
        ...
        Object.defineProperty(TuiHostedDropdownComponent.prototype, "hostEditable", {
            get: function () {
                var host = this.nativeFocusableElement || this.host;
                // TODO: iframe warning
                return host instanceof HTMLElement && cdk.isElementEditable(host);
            },
            enumerable: true,
            configurable: true
        });
        TuiHostedDropdownComponent.prototype.focusDropdown = function (event, first) {
            ...
            var focusable = cdk.getClosestFocusable(initial, !first, this.wrapper.nativeElement);
            if (focusable === null) {
                return;
            }
            cdk.setNativeFocused(focusable);
            event.preventDefault();
        };
        ...
        TuiHostedDropdownComponent.prototype.focusHost = function () {
            var host = this.nativeFocusableElement;
            if (host !== null) {
                cdk.setNativeFocused(host, true, true);
            }
        };
        ...
        TuiHostedDropdownComponent.ctorParameters = function () { return [
            ...
            { type: dropdownController.TuiDropdownControllerDirective, decorators: [{ type: core.Inject, args: [dropdownController.TUI_DROPDOWN_WATCHED_CONTROLLER,] }] }
        ]; };
        __decorate([
            core.ContentChild(TuiHostedDropdownConnectorDirective, { read: core.ElementRef })
        ], TuiHostedDropdownComponent.prototype, "dropdownHost", void 0);
        __decorate([
            core.ViewChild('wrapper', { read: core.ElementRef })
        ], TuiHostedDropdownComponent.prototype, "wrapper", void 0);
        __decorate([
            core.ViewChild(dropdown.TuiDropdownDirective)
        ...
        __decorate([
            core.HostBinding('class._hosted_dropdown_focused')
        ], TuiHostedDropdownComponent.prototype, "focused", null);
        __decorate([
            core.HostListener('focusin', ['$event.target'])
        ...
        __decorate([
            core.HostListener('keydown.arrowDown', ['$event', 'true']),
            core.HostListener('keydown.arrowUp', ['$event', 'false'])
        ...
        TuiHostedDropdownComponent = TuiHostedDropdownComponent_1 = __decorate([
                ...
                providers: [
                    {
                        ...
                        useExisting: core.forwardRef(function () { return TuiHostedDropdownComponent_1; }),
                    },
                    dropdownController.DROPDOWN_CONTROLLER_PROVIDER,
                ],
            ...
            __param(1, core.Inject(dropdownController.TUI_DROPDOWN_WATCHED_CONTROLLER))
