(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('@taiga-ui/core/utils/format', ['exports', '@taiga-ui/cdk'], factory) :
    (global = global || self, factory((global['taiga-ui'] = global['taiga-ui'] || {}, global['taiga-ui'].core = global['taiga-ui'].core || {}, global['taiga-ui'].core.utils = global['taiga-ui'].core.utils || {}, global['taiga-ui'].core.utils.format = {}), global.cdk));
    ...
    ***************************************************************************** */
    ...
    function formatNumber(value, decimalLimit, decimalSeparator, thousandSeparator, zeroPadding) {
        ...
        if (thousandSeparator === void 0) { thousandSeparator = cdk.CHAR_NO_BREAK_SPACE; }
    ...
    exports.getFractionPartPadded = getFractionPartPadded;
    exports.numberToStringWithoutExp = numberToStringWithoutExp;
    exports.otherDecimalSymbol = otherDecimalSymbol;
    ...
    exports.tuiPluralizeToICU = tuiPluralizeToICU;
