(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@taiga-ui/cdk'), require('@taiga-ui/core/directives'), require('rxjs'), require('rxjs/operators'), require('@angular/common'), require('@taiga-ui/core/components/loader'), require('@taiga-ui/core/components/svg'), require('@taiga-ui/core/directives/wrapper'), require('@tinkoff/ng-polymorpheus')) :
    typeof define === 'function' && define.amd ? define('@taiga-ui/core/components/button', ['exports', '@angular/core', '@taiga-ui/cdk', '@taiga-ui/core/directives', 'rxjs', 'rxjs/operators', '@angular/common', '@taiga-ui/core/components/loader', '@taiga-ui/core/components/svg', '@taiga-ui/core/directives/wrapper', '@tinkoff/ng-polymorpheus'], factory) :
    (global = global || self, factory((global['taiga-ui'] = global['taiga-ui'] || {}, global['taiga-ui'].core = global['taiga-ui'].core || {}, global['taiga-ui'].core.components = global['taiga-ui'].core.components || {}, global['taiga-ui'].core.components.button = {}), global.ng.core, global.cdk, global['taiga-ui'].core.directives, global.rxjs, global.rxjs.operators, global.ng.common, global['taiga-ui'].core.components.loader, global['taiga-ui'].core.components.svg, global['taiga-ui'].core.directives.wrapper, global.ngPolymorpheus));
}(this, (function (exports, core, cdk, directives, rxjs, operators, common, loader, svg, wrapper, ngPolymorpheus) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var TUI_BUTTON_OPTIONS = new core.InjectionToken("Default parameters for button component", {
        factory: function () { return TUI_BUTTON_DEFAULT_OPTIONS; },
    });
    var tuiButtonOptionsProvider = function (options) { return ({
    ...
    var TuiButtonComponent = /** @class */ (function (_super) {
        ...
        function TuiButtonComponent(mode, elementRef, focusVisible$, hoveredService, destroy$, changeDetectorRef, takeOnlyTrustedEvents, options) {
            ...
            cdk.pressedObservable(elementRef.nativeElement, {
        ...
        Object.defineProperty(TuiButtonComponent.prototype, "focused", {
            get: function () {
                return !this.showLoader && cdk.isNativeFocused(this.elementRef.nativeElement);
            },
            enumerable: true,
            configurable: true
        });
        ...
        TuiButtonComponent.ctorParameters = function () { return [
            { type: directives.TuiModeDirective, decorators: [{ type: core.Optional }, { type: core.Inject, args: [directives.TuiModeDirective,] }] },
            ...
            { type: Boolean, decorators: [{ type: core.Inject, args: [cdk.TUI_TAKE_ONLY_TRUSTED_EVENTS,] }] },
            { type: undefined, decorators: [{ type: core.Inject, args: [TUI_BUTTON_OPTIONS,] }] }
        ]; };
        __decorate([
            core.Input(),
            cdk.tuiDefaultProp()
        ...
        __decorate([
            core.Input(),
            core.HostBinding('attr.data-shape'),
            cdk.tuiDefaultProp()
        ], TuiButtonComponent.prototype, "shape", void 0);
        __decorate([
            core.Input(),
            core.HostBinding('class._loading'),
            cdk.tuiDefaultProp()
        ...
        __decorate([
            core.HostBinding('attr.data-appearance')
        ...
        TuiButtonComponent = TuiButtonComponent_1 = __decorate([
                ...
                providers: [
                    {
                        ...
                        useExisting: core.forwardRef(function () { return TuiButtonComponent_1; }),
                    },
            ...
            __param(0, core.Inject(directives.TuiModeDirective)),
            __param(1, core.Inject(core.ElementRef)),
            __param(2, core.Inject(cdk.TuiFocusVisibleService)),
            __param(3, core.Inject(cdk.TuiHoveredService)),
            __param(4, core.Inject(cdk.TuiDestroyService)),
            __param(5, core.Inject(core.ChangeDetectorRef)),
            __param(6, core.Inject(cdk.TUI_TAKE_ONLY_TRUSTED_EVENTS)),
            __param(7, core.Inject(TUI_BUTTON_OPTIONS))
        ], TuiButtonComponent);
