(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('@taiga-ui/core/components/svg', ['exports', '@angular/common', '@angular/core', '@angular/platform-browser', '@ng-web-apis/common', '@taiga-ui/cdk', '@taiga-ui/core/constants', '@taiga-ui/core/services', '@taiga-ui/core/tokens', '@taiga-ui/core/utils/miscellaneous', 'rxjs', 'rxjs/operators'], factory) :
    (global = global || self, factory((global['taiga-ui'] = global['taiga-ui'] || {}, global['taiga-ui'].core = global['taiga-ui'].core || {}, global['taiga-ui'].core.components = global['taiga-ui'].core.components || {}, global['taiga-ui'].core.components.svg = {}), global.ng.common, global.ng.core, global.ng.platformBrowser, global.common$1, global.cdk, global['taiga-ui'].core.constants, global['taiga-ui'].core.services, global['taiga-ui'].core.tokens, global['taiga-ui'].core.utils.miscellaneous, global.rxjs, global.rxjs.operators));
}(this, (function (exports, common, core, platformBrowser, common$1, cdk, constants, services, tokens, miscellaneous, rxjs, operators) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var TuiSvgComponent = /** @class */ (function () {
        function TuiSvgComponent(documentRef, windowRef, iconsPath, tuiSanitizer, svgService, staticRequestService, sanitizer, elementRef, userAgent, srcProcessor, contentProcessor) {
            ...
            this.isIE = cdk.isIE(this.userAgent);
            this.icon = '';
        ...
        Object.defineProperty(TuiSvgComponent.prototype, "isShadowDOM", {
            get: function () {
                return (cdk.getDocumentOrShadowRoot(this.elementRef.nativeElement) !== this.documentRef);
            },
            enumerable: true,
            configurable: true
        });
        ...
        Object.defineProperty(TuiSvgComponent.prototype, "isSrc", {
            get: function () {
                return miscellaneous.isPresumedHTMLString(this.icon);
            },
            enumerable: true,
            configurable: true
        });
        ...
        TuiSvgComponent.prototype.onError = function (message) {
            ...
            var icon = this.icon;
            var event = cdk.tuiCustomEvent(constants.TUI_ICON_ERROR, {
                bubbles: true,
                detail: {
                    message: message,
                    icon: icon,
            ...
            cdk.tuiAssert.assert(false, message, icon);
        ...
        TuiSvgComponent.prototype.sanitize = function (src) {
            ...
            return this.tuiSanitizer
                ? this.sanitizer.bypassSecurityTrustHtml(this.tuiSanitizer.sanitize(core.SecurityContext.HTML, src) || '')
                : src;
        };
        ...
        TuiSvgComponent.ctorParameters = function () { return [
            ...
            { type: undefined, decorators: [{ type: core.Inject, args: [tokens.TUI_ICONS_PATH,] }] },
            { type: core.Sanitizer, decorators: [{ type: core.Optional }, { type: core.Inject, args: [tokens.TUI_SANITIZER,] }] },
            { type: services.TuiSvgService, decorators: [{ type: core.Inject, args: [services.TuiSvgService,] }] },
            { type: cdk.TuiStaticRequestService, decorators: [{ type: core.Inject, args: [cdk.TuiStaticRequestService,] }] },
            ...
            { type: undefined, decorators: [{ type: core.Inject, args: [tokens.TUI_SVG_SRC_PROCESSOR,] }] },
            { type: undefined, decorators: [{ type: core.Inject, args: [tokens.TUI_SVG_CONTENT_PROCESSOR,] }] }
        ]; };
        __decorate([
            core.Input(),
        ...
        TuiSvgComponent = __decorate([
            ...
            __param(2, core.Inject(tokens.TUI_ICONS_PATH)),
            __param(3, core.Optional()),
            __param(3, core.Inject(tokens.TUI_SANITIZER)),
            __param(4, core.Inject(services.TuiSvgService)),
            __param(5, core.Inject(cdk.TuiStaticRequestService)),
            __param(6, core.Inject(platformBrowser.DomSanitizer)),
            __param(7, core.Inject(core.ElementRef)),
            __param(8, core.Inject(common$1.USER_AGENT)),
            __param(9, core.Inject(tokens.TUI_SVG_SRC_PROCESSOR)),
            __param(10, core.Inject(tokens.TUI_SVG_CONTENT_PROCESSOR))
        ], TuiSvgComponent);
    ...
    var TuiSvgModule = /** @class */ (function () {
        ...
        TuiSvgModule = __decorate([
            core.NgModule({
                imports: [common.CommonModule, cdk.TuiLetModule],
