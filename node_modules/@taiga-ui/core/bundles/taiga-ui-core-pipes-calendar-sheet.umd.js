(function (global, factory) {
    ...
    (global = global || self, factory((global['taiga-ui'] = global['taiga-ui'] || {}, global['taiga-ui'].core = global['taiga-ui'].core || {}, global['taiga-ui'].core.pipes = global['taiga-ui'].core.pipes || {}, global['taiga-ui'].core.pipes['calendar-sheet'] = {}), global.ng.core, global.cdk, global['taiga-ui'].core.tokens));
}(this, (function (exports, core, cdk, tokens) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var getDayFromMonthRowCol = function (_a) {
        ...
        cdk.tuiAssert.assert(Number.isInteger(rowIndex));
        cdk.tuiAssert.assert(cdk.inRange(rowIndex, 0, 6));
        cdk.tuiAssert.assert(Number.isInteger(colIndex));
        cdk.tuiAssert.assert(cdk.inRange(colIndex, 0, cdk.DAYS_IN_WEEK));
    ...
    var TuiCalendarSheetPipe = /** @class */ (function () {
        ...
        TuiCalendarSheetPipe.ctorParameters = function () { return [
            { type: undefined, decorators: [{ type: core.Inject, args: [tokens.TUI_FIRST_DAY_OF_WEEK,] }] }
        ]; };
        TuiCalendarSheetPipe = __decorate([
            core.Pipe({
                name: "tuiCalendarSheet",
            }),
            __param(0, core.Inject(tokens.TUI_FIRST_DAY_OF_WEEK))
