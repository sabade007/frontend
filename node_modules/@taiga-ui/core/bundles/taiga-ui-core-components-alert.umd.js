(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@taiga-ui/cdk'), require('@taiga-ui/core/animations'), require('@taiga-ui/core/tokens'), require('@tinkoff/ng-polymorpheus'), require('rxjs'), require('rxjs/operators'), require('@angular/common'), require('@taiga-ui/core/components/notification'), require('@taiga-ui/cdk/services')) :
    typeof define === 'function' && define.amd ? define('@taiga-ui/core/components/alert', ['exports', '@angular/core', '@taiga-ui/cdk', '@taiga-ui/core/animations', '@taiga-ui/core/tokens', '@tinkoff/ng-polymorpheus', 'rxjs', 'rxjs/operators', '@angular/common', '@taiga-ui/core/components/notification', '@taiga-ui/cdk/services'], factory) :
    (global = global || self, factory((global['taiga-ui'] = global['taiga-ui'] || {}, global['taiga-ui'].core = global['taiga-ui'].core || {}, global['taiga-ui'].core.components = global['taiga-ui'].core.components || {}, global['taiga-ui'].core.components.alert = {}), global.ng.core, global.cdk, global['taiga-ui'].core.animations, global['taiga-ui'].core.tokens, global.ngPolymorpheus, global.rxjs, global.rxjs.operators, global.ng.common, global['taiga-ui'].core.components.notification, global.services));
}(this, (function (exports, core, cdk, animations, tokens, ngPolymorpheus, rxjs, operators, common, notification, services) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var TuiAlertComponent = /** @class */ (function () {
        ...
        TuiAlertComponent.prototype.initAutoClose = function () {
            ...
            rxjs.timer(cdk.isNumber(this.autoClose) ? this.autoClose : this.options.defaultAutoCloseTime)
                .pipe(operators.takeUntil(rxjs.fromEvent(this.elementRef.nativeElement, 'mouseenter')), 
            // eslint-disable-next-line rxjs/no-ignored-notifier
            operators.repeatWhen(function () { return rxjs.fromEvent(_this.elementRef.nativeElement, 'mouseleave'); }), operators.takeUntil(this.destroy$))
        ...
        TuiAlertComponent.ctorParameters = function () { return [
            ...
            { type: undefined, decorators: [{ type: core.Inject, args: [tokens.TUI_NOTIFICATION_OPTIONS,] }] },
            { type: undefined, decorators: [{ type: core.Inject, args: [tokens.TUI_ANIMATION_OPTIONS,] }] },
            { type: undefined, decorators: [{ type: core.Inject, args: [ngPolymorpheus.POLYMORPHEUS_CONTEXT,] }] }
        ]; };
        __decorate([
            core.HostBinding('@tuiFadeIn'),
            core.HostBinding('@tuiSlideInRight'),
            core.HostBinding('@tuiHeightCollapse')
        ...
        TuiAlertComponent = __decorate([
            core.Component({
                ...
                animations: [animations.tuiFadeIn, animations.tuiSlideInRight, animations.tuiHeightCollapse],
                host: { role: 'alert' },
            ...
            __param(2, core.Inject(tokens.TUI_NOTIFICATION_OPTIONS)),
            __param(3, core.Inject(tokens.TUI_ANIMATION_OPTIONS)),
            __param(4, core.Inject(ngPolymorpheus.POLYMORPHEUS_CONTEXT))
        ], TuiAlertComponent);
    ...
    var TuiAlertService = /** @class */ (function (_super) {
        ...
        function TuiAlertService(defaultOptions, idService) {
            ...
            _this.component = new ngPolymorpheus.PolymorpheusComponent(TuiAlertComponent);
            return _this;
        }
        ...
        TuiAlertService.ɵprov = core.ɵɵdefineInjectable({ factory: function TuiAlertService_Factory() { return new TuiAlertService(core.ɵɵinject(tokens.TUI_NOTIFICATION_OPTIONS), core.ɵɵinject(services.TuiIdService)); }, token: TuiAlertService, providedIn: "root" });
        TuiAlertService = __decorate([
            core.Injectable({ providedIn: "root" }),
            __param(0, core.Inject(tokens.TUI_NOTIFICATION_OPTIONS)),
            __param(1, core.Inject(cdk.TuiIdService))
        ], TuiAlertService);
    ...
    var TuiNotificationsService = /** @class */ (function () {
        ...
        TuiNotificationsService.ctorParameters = function () { return [
            { type: TuiAlertService, decorators: [{ type: core.Inject, args: [TuiAlertService,] }] }
        ]; };
        TuiNotificationsService.ɵprov = core.ɵɵdefineInjectable({ factory: function TuiNotificationsService_Factory() { return new TuiNotificationsService(core.ɵɵinject(TuiAlertService)); }, token: TuiNotificationsService, providedIn: "root" });
        TuiNotificationsService = __decorate([
            core.Injectable({ providedIn: "root" }),
            __param(0, core.Inject(TuiAlertService))
    ...
    var TuiAlertModule = /** @class */ (function () {
        ...
        TuiAlertModule = __decorate([
            core.NgModule({
                imports: [common.CommonModule, ngPolymorpheus.PolymorpheusModule, notification.TuiNotificationModule],
    ...
    var TuiNotificationsModule = /** @class */ (function () {
        ...
        TuiNotificationsModule = __decorate([
            core.NgModule({ imports: [TuiAlertModule] })
    ...
    exports.TuiNotificationsModule = TuiNotificationsModule;
    exports.TuiNotificationsService = TuiNotificationsService;
