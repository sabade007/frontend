(function (global, factory) {
    ...
    (global = global || self, factory((global['taiga-ui'] = global['taiga-ui'] || {}, global['taiga-ui'].core = global['taiga-ui'].core || {}, global['taiga-ui'].core.components = global['taiga-ui'].core.components || {}, global['taiga-ui'].core.components.loader = {}), global.ng.common, global.ng.core, global.cdk, global['taiga-ui'].core.utils.miscellaneous, global.ngPolymorpheus));
}(this, (function (exports, common, core, cdk, miscellaneous, ngPolymorpheus) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var TUI_LOADER_OPTIONS = new core.InjectionToken("Default parameters for loader component", {
    ...
    var tuiLoaderOptionsProvider = function (options) { return ({
        ...
        useValue: __assign(__assign({}, TUI_LOADER_DEFAULT_OPTIONS), options),
    }); };
    ...
    var TuiLoaderComponent = /** @class */ (function () {
        function TuiLoaderComponent(documentRef, elementRef, isIos, options) {
            ...
            this.loading = true;
            this.isApple = cdk.isSafari(this.elementRef.nativeElement) || this.isIos;
        }
        Object.defineProperty(TuiLoaderComponent.prototype, "showLoader", {
            set: function (value) {
                ...
                if (value && this.focused) {
                    cdk.blurNativeFocused(this.documentRef);
                }
                this.loading = value;
            },
            enumerable: true,
        ...
        Object.defineProperty(TuiLoaderComponent.prototype, "isHorizontal", {
            get: function () {
                return !miscellaneous.sizeBigger(this.size);
            },
            enumerable: true,
            configurable: true
        });
        ...
        TuiLoaderComponent.ctorParameters = function () { return [
            ...
            { type: undefined, decorators: [{ type: core.Inject, args: [TUI_LOADER_OPTIONS,] }] }
        ]; };
        __decorate([
            core.Input(),
            cdk.tuiDefaultProp()
        ...
        TuiLoaderComponent = __decorate([
            ...
            __param(3, core.Inject(TUI_LOADER_OPTIONS))
        ], TuiLoaderComponent);
