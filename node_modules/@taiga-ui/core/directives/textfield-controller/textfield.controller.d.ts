...
export declare class TuiTextfieldController {
    ...
    private readonly autocompleteDirective;
    private readonly cleanerDirective;
    private readonly customContentDirective;
    private readonly exampleTextDirective;
    private readonly inputModeDirective;
    private readonly labelOutsideDirective;
    private readonly maxLengthDirective;
    private readonly sizeDirective;
    private readonly typeDirective;
    constructor(change$: Observable<void>, autocompleteDirective: TuiTextfieldAutocompleteDirective, cleanerDirective: TuiTextfieldCleanerDirective, customContentDirective: TuiTextfieldCustomContentDirective, exampleTextDirective: TuiTextfieldExampleTextDirective, inputModeDirective: TuiTextfieldInputModeDirective, labelOutsideDirective: TuiTextfieldLabelOutsideDirective, maxLengthDirective: TuiTextfieldMaxLengthDirective, sizeDirective: TuiTextfieldSizeDirective, typeDirective: TuiTextfieldTypeDirective);
