(function (global, factory) {
    ...
    (global = global || self, factory((global['taiga-ui'] = global['taiga-ui'] || {}, global['taiga-ui'].cdk = global['taiga-ui'].cdk || {}, global['taiga-ui'].cdk.directives = global['taiga-ui'].cdk.directives || {}, global['taiga-ui'].cdk.directives['for-async'] = {}), global.ng.core, global.rxjs, global.rxjs.operators));
    ...
    ***************************************************************************** */
    ...
    var TuiForAsyncDirective = /** @class */ (function () {
        ...
        TuiForAsyncDirective.prototype.createAsyncViewForNewNodes = function () {
            var _this = this;
            rxjs.from((this.tuiForAsyncOf || []).entries())
                .pipe(operators.concatMap(function (entry) { return rxjs.of(entry).pipe(operators.delay(_this.tuiForAsyncTimeout)); }), operators.takeUntil(this.destroy$))
        ...
        TuiForAsyncDirective = __decorate([
            core.Directive({ selector: '[tuiForAsync][tuiForAsyncOf]' }),
