(function (global, factory) {
    ...
    (global = global || self, factory((global['taiga-ui'] = global['taiga-ui'] || {}, global['taiga-ui'].cdk = global['taiga-ui'].cdk || {}, global['taiga-ui'].cdk.directives = global['taiga-ui'].cdk.directives || {}, global['taiga-ui'].cdk.directives.media = {}), global.ng.core, global['taiga-ui'].cdk.decorators));
}(this, (function (exports, core, decorators) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var TuiMediaDirective = /** @class */ (function () {
        ...
        __decorate([
            core.Input(),
            core.HostBinding('volume'),
            decorators.tuiDefaultProp(volumeAssertion)
        ], TuiMediaDirective.prototype, "volume", void 0);
        __decorate([
            core.Input('playbackRate'),
        ...
        __decorate([
            core.HostListener('ended', ['true']),
            core.HostListener('pause', ['true']),
            core.HostListener('play', ['false'])
        ], TuiMediaDirective.prototype, "onPausedChange", null);
        __decorate([
            core.HostListener('volumechange')
        ], TuiMediaDirective.prototype, "onVolumeChange", null);
        __decorate([
            core.HostListener('timeupdate'),
            core.HostListener('seeking'),
            core.HostListener('seeked')
        ], TuiMediaDirective.prototype, "onCurrentTimeChange", null);
        __decorate([
            core.HostListener('durationchange')
    ...
    exports.nonNegativeFiniteAssertion = nonNegativeFiniteAssertion;
