(function (global, factory) {
    ...
    (global = global || self, factory((global['taiga-ui'] = global['taiga-ui'] || {}, global['taiga-ui'].cdk = global['taiga-ui'].cdk || {}, global['taiga-ui'].cdk.directives = global['taiga-ui'].cdk.directives || {}, global['taiga-ui'].cdk.directives.focused = {}), global.ng.core, global['taiga-ui'].cdk.observables, global['taiga-ui'].cdk.utils.focus, global.rxjs, global.rxjs.operators));
}(this, (function (exports, core, observables, focus, rxjs, operators) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var TuiFocusedDirective = /** @class */ (function () {
        function TuiFocusedDirective(_a, ngZone) {
            ...
            this.tuiFocusedChange = rxjs.merge(observables.typedFromEvent(nativeElement, 'focusin'), observables.typedFromEvent(nativeElement, 'focusout')).pipe(operators.map(function () { return focus.isNativeFocused(nativeElement); }), operators.startWith(false), operators.distinctUntilChanged(), operators.skip(1), observables.tuiZoneOptimized(ngZone));
        }
