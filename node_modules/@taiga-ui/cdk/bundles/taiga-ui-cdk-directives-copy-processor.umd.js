(function (global, factory) {
    ...
    (global = global || self, factory((global['taiga-ui'] = global['taiga-ui'] || {}, global['taiga-ui'].cdk = global['taiga-ui'].cdk || {}, global['taiga-ui'].cdk.directives = global['taiga-ui'].cdk.directives || {}, global['taiga-ui'].cdk.directives['copy-processor'] = {}), global.ng.core, global.common, global['taiga-ui'].cdk.decorators, global['taiga-ui'].cdk.utils, global.rxjs));
}(this, (function (exports, core, common, decorators, utils, rxjs) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var TuiCopyProcessorDirective = /** @class */ (function () {
        ...
        TuiCopyProcessorDirective.prototype.onCopy = function (event) {
            var _a;
            var text = utils.tuiGetSelectedText(this.windowRef);
            if (text) {
        ...
        __decorate([
            core.HostListener('copy.prevent', ['$event'])
