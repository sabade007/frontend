(function (global, factory) {
    ...
    (global = global || self, factory((global['taiga-ui'] = global['taiga-ui'] || {}, global['taiga-ui'].cdk = global['taiga-ui'].cdk || {}, global['taiga-ui'].cdk.directives = global['taiga-ui'].cdk.directives || {}, global['taiga-ui'].cdk.directives['prevent-default'] = {}), global.ng.core, global['taiga-ui'].cdk.observables, global['taiga-ui'].cdk.services, global.rxjs, global.rxjs.operators));
}(this, (function (exports, core, observables, services, rxjs, operators) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var TuiPreventDefaultDirective = /** @class */ (function () {
        function TuiPreventDefaultDirective(_a, ngZone, destroy$, eventName) {
            var nativeElement = _a.nativeElement;
            rxjs.fromEvent(nativeElement, eventName, { passive: false })
                .pipe(observables.tuiZonefree(ngZone), observables.preventDefault(), operators.takeUntil(destroy$))
                .subscribe();
        }
        TuiPreventDefaultDirective.ctorParameters = function () { return [
            ...
            { type: String, decorators: [{ type: core.Attribute, args: ['tuiPreventDefault',] }] }
        ]; };
        TuiPreventDefaultDirective = __decorate([
            ...
            __param(2, core.Inject(services.TuiDestroyService)),
            __param(3, core.Attribute('tuiPreventDefault'))
