(function (global, factory) {
    ...
    (global = global || self, factory((global['taiga-ui'] = global['taiga-ui'] || {}, global['taiga-ui'].cdk = global['taiga-ui'].cdk || {}, global['taiga-ui'].cdk.pipes = global['taiga-ui'].cdk.pipes || {}, global['taiga-ui'].cdk.pipes.filter = {}), global.ng.core));
    ...
    ***************************************************************************** */
    ...
    var TuiFilterPipe = /** @class */ (function () {
        ...
        TuiFilterPipe.prototype.transform = function (items, matcher) {
            ...
            return items.filter(function (item) { return matcher.apply(void 0, __spread([item], args)); });
        };
        TuiFilterPipe = __decorate([
            core.Pipe({ name: "tuiFilter" })
        ], TuiFilterPipe);
    ...
    var TuiFilterPipeModule = /** @class */ (function () {
        ...
        TuiFilterPipeModule = __decorate([
            core.NgModule({
