(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@taiga-ui/cdk/constants'), require('@taiga-ui/cdk/classes'), require('@taiga-ui/cdk/exceptions'), require('@taiga-ui/cdk/utils/format'), require('@taiga-ui/cdk/utils/math')) :
    typeof define === 'function' && define.amd ? define('@taiga-ui/cdk/date-time', ['exports', '@angular/core', '@taiga-ui/cdk/constants', '@taiga-ui/cdk/classes', '@taiga-ui/cdk/exceptions', '@taiga-ui/cdk/utils/format', '@taiga-ui/cdk/utils/math'], factory) :
    (global = global || self, factory((global['taiga-ui'] = global['taiga-ui'] || {}, global['taiga-ui'].cdk = global['taiga-ui'].cdk || {}, global['taiga-ui'].cdk['date-time'] = {}), global.ng.core, global['taiga-ui'].cdk.constants, global['taiga-ui'].cdk.classes, global['taiga-ui'].cdk.exceptions, global['taiga-ui'].cdk.utils.format, global['taiga-ui'].cdk.utils.math));
}(this, (function (exports, core, constants, classes, exceptions, format, math) { 'use strict';
    ...
    ***************************************************************************** */
     ...
     */
    var TUI_DATE_FILLER = new core.InjectionToken("date filler for Taiga UI", {
        factory: function () { return "dd.mm.yyyy"; },
    });
    /**
     * @deprecated dont use it
     */
    var TUI_DATE_RANGE_FILLER = new core.InjectionToken("date range filler for Taiga UI", {
        factory: function () {
            var dateFiller = core.inject(TUI_DATE_FILLER);
    ...
    var TUI_DATE_FORMAT = new core.InjectionToken("Active date format for Taiga UI", {
    ...
    var TuiYear = /** @class */ (function () {
        ...
        Object.defineProperty(TuiYear.prototype, "formattedYear", {
            get: function () {
                return format.padStart(String(this.year), 4, "0");
            },
            enumerable: true,
            configurable: true
        });
    ...
    var TuiMonth = /** @class */ (function (_super) {
        ...
        Object.defineProperty(TuiMonth.prototype, "formattedMonthPart", {
            get: function () {
                return format.padStart(String(this.month + 1), 2, "0");
            },
            enumerable: true,
            configurable: true
        });
    ...
    var TuiDay = /** @class */ (function (_super) {
        ...
        TuiDay.jsonParse = function (yearMonthDayString) {
            ...
            if (!TuiYear.isValidYear(year)) {
                throw new exceptions.InvalidYearException(year);
            }
            if (!TuiMonth.isValidMonth(year, month)) {
                throw new exceptions.InvalidMonthException(month);
            }
            if (!Number.isInteger(day) ||
                !math.inRange(day, MIN_DAY, TuiMonth.getMonthDaysCount(month, TuiYear.isLeapYear(year)) + 1)) {
                throw new exceptions.InvalidDayException(day);
            }
            return new TuiDay(year, month, day);
        };
        ...
        Object.defineProperty(TuiDay.prototype, "formattedDayPart", {
            get: function () {
                return format.padStart(String(this.day), 2, "0");
            },
            enumerable: true,
            configurable: true
        });
    ...
    var TuiTime = /** @class */ (function () {
        ...
        TuiTime.isValidTime = function (hours, minutes, seconds, ms) {
            ...
            return (Number.isInteger(hours) &&
                math.inRange(hours, 0, HOURS_IN_DAY) &&
                Number.isInteger(minutes) &&
                math.inRange(minutes, 0, MINUTES_IN_HOUR) &&
                Number.isInteger(seconds) &&
                math.inRange(seconds, 0, SECONDS_IN_MINUTE) &&
                Number.isInteger(ms) &&
                math.inRange(ms, 0, 1000));
        };
        /**
         * Current UTC time.
         */
        ...
        TuiTime.fromAbsoluteMilliseconds = function (milliseconds) {
            ...
            classes.tuiAssert.assert(math.inRange(milliseconds, 0, MILLISECONDS_IN_DAY), "Milliseconds must be below " + MILLISECONDS_IN_DAY + " (milliseconds in a day).");
        ...
        TuiTime.prototype.formatTime = function (time, digits) {
            ...
            return format.padStart(String(time), digits, "0");
        };
        return TuiTime;
    }());
