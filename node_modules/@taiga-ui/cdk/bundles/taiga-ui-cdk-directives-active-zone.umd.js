(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@taiga-ui/cdk/decorators'), require('@taiga-ui/cdk/observables'), require('@taiga-ui/cdk/tokens'), require('rxjs'), require('rxjs/operators')) :
    typeof define === 'function' && define.amd ? define('@taiga-ui/cdk/directives/active-zone', ['exports', '@angular/core', '@taiga-ui/cdk/decorators', '@taiga-ui/cdk/observables', '@taiga-ui/cdk/tokens', 'rxjs', 'rxjs/operators'], factory) :
    (global = global || self, factory((global['taiga-ui'] = global['taiga-ui'] || {}, global['taiga-ui'].cdk = global['taiga-ui'].cdk || {}, global['taiga-ui'].cdk.directives = global['taiga-ui'].cdk.directives || {}, global['taiga-ui'].cdk.directives['active-zone'] = {}), global.ng.core, global['taiga-ui'].cdk.decorators, global['taiga-ui'].cdk.observables, global['taiga-ui'].cdk.tokens, global.rxjs, global.rxjs.operators));
}(this, (function (exports, core, decorators, observables, tokens, rxjs, operators) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var TuiActiveZoneDirective = /** @class */ (function () {
        ...
        TuiActiveZoneDirective.ctorParameters = function () { return [
            { type: rxjs.Observable, decorators: [{ type: core.Inject, args: [tokens.TUI_ACTIVE_ELEMENT,] }] },
            { type: core.NgZone, decorators: [{ type: core.Inject, args: [core.NgZone,] }] },
            { type: core.ElementRef, decorators: [{ type: core.Inject, args: [core.ElementRef,] }] },
            { type: TuiActiveZoneDirective, decorators: [{ type: core.Optional }, { type: core.SkipSelf }, { type: core.Inject, args: [TuiActiveZoneDirective_1,] }] }
        ]; };
        __decorate([
            core.Input('tuiActiveZoneParent'),
