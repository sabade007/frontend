(function (global, factory) {
    ...
    (global = global || self, factory((global['taiga-ui'] = global['taiga-ui'] || {}, global['taiga-ui'].cdk = global['taiga-ui'].cdk || {}, global['taiga-ui'].cdk.decorators = {}), global['taiga-ui'].cdk.classes, global['taiga-ui'].cdk.exceptions));
    ...
    function tuiDefaultProp(assertion) {
        ...
        return function (target, key) {
            ...
            Object.defineProperty(target, key, {
                configurable: true,
                get: function () {
                    classes.tuiAssert.assert(false, errorGetDefaultMessage);
                    return undefined;
                },
                set: function (initialValue) {
                    ...
                    classes.tuiAssert.assert(isValid, errorMessage);
                    if (isValid && assertion) {
                        classes.tuiAssert.assert.apply(classes.tuiAssert, __spread([assertion.call(this, initialValue),
                    ...
                    Object.defineProperty(this, key, {
                        ...
                        set: function (value) {
                            ...
                            if (isValid && assertion) {
                                classes.tuiAssert.assert.apply(classes.tuiAssert, __spread([assertion.call(this, value),
                                    String(key) + " in " + name + " received:",
                                    value], args));
                            }
