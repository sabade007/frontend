(function (global, factory) {
    ...
    (global = global || self, factory((global['taiga-ui'] = global['taiga-ui'] || {}, global['taiga-ui'].cdk = global['taiga-ui'].cdk || {}, global['taiga-ui'].cdk.directives = global['taiga-ui'].cdk.directives || {}, global['taiga-ui'].cdk.directives['input-mode'] = {}), global.ng.core, global['taiga-ui'].cdk.tokens));
    ...
    ***************************************************************************** */
    ...
    var TuiInputModeDirective = /** @class */ (function () {
        ...
        TuiInputModeDirective.ctorParameters = function () { return [
            { type: String, decorators: [{ type: core.Attribute, args: ['pattern',] }] },
            { type: Boolean, decorators: [{ type: core.Inject, args: [tokens.TUI_IS_IOS,] }] }
        ]; };
        __decorate([
            core.Input('tuiInputMode'),
            core.HostBinding('attr.inputmode'),
            core.HostBinding('attr.x-inputmode')
        ], TuiInputModeDirective.prototype, "mode", void 0);
        __decorate([
            core.HostBinding('attr.pattern')
        ], TuiInputModeDirective.prototype, "patternAttribute", null);
        TuiInputModeDirective = __decorate([
            core.Directive({
                selector: 'input[tuiInputMode]',
            }),
            __param(0, core.Attribute('pattern')),
            __param(1, core.Inject(tokens.TUI_IS_IOS))
