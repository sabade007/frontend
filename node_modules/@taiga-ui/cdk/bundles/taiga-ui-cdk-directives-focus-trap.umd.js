(function (global, factory) {
    ...
    (global = global || self, factory((global['taiga-ui'] = global['taiga-ui'] || {}, global['taiga-ui'].cdk = global['taiga-ui'].cdk || {}, global['taiga-ui'].cdk.directives = global['taiga-ui'].cdk.directives || {}, global['taiga-ui'].cdk.directives['focus-trap'] = {}), global.ng.common, global.ng.core, global['taiga-ui'].cdk.utils.dom, global['taiga-ui'].cdk.utils.focus));
}(this, (function (exports, common, core, dom, focus) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var TuiFocusTrapDirective = /** @class */ (function () {
        function TuiFocusTrapDirective(documentRef, elementRef, renderer) {
            ...
            this.activeElement = focus.getNativeFocused(this.documentRef);
            /**
            ...
            Promise.resolve().then(function () {
                focus.setNativeFocused(_this.elementRef.nativeElement);
            });
        }
        ...
        TuiFocusTrapDirective.prototype.onFocusIn = function (node) {
            if (dom.containsOrAfter(this.elementRef.nativeElement, node)) {
                return;
            }
            var focusable = focus.getClosestFocusable(this.elementRef.nativeElement, false, this.elementRef.nativeElement);
            if (focusable) {
                focus.setNativeFocused(focusable);
            }
        };
        TuiFocusTrapDirective.prototype.ngOnDestroy = function () {
            var _this = this;
            focus.blurNativeFocused(this.documentRef);
            /**
            ...
            Promise.resolve().then(function () {
                ...
                if (_this.activeElement instanceof HTMLElement) {
                    focus.setNativeFocused(_this.activeElement);
                }
            });
        };
        ...
        __decorate([
            core.HostListener('window:focusin.silent', ['$event.target'])
