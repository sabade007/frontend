(function (global, factory) {
    ...
    (global = global || self, factory((global['taiga-ui'] = global['taiga-ui'] || {}, global['taiga-ui'].cdk = global['taiga-ui'].cdk || {}, global['taiga-ui'].cdk.utils = global['taiga-ui'].cdk.utils || {}, global['taiga-ui'].cdk.utils.dom = {}), global['taiga-ui'].cdk.utils.math, global['taiga-ui'].cdk.utils.miscellaneous, global['taiga-ui'].cdk.classes));
    ...
    function getElementObscurers(element) {
        ...
        var left = math.clamp(Math.round(rect.left) + 2, 0, innerWidth);
        var top = math.clamp(Math.round(rect.top) + 2, 0, innerHeight);
        var right = math.clamp(Math.round(rect.right) - 2, 0, innerWidth);
        var bottom = math.clamp(Math.round(rect.bottom) - 2, 0, innerHeight);
        var horizontalMiddle = math.clamp(Math.round(rect.left + rect.width / 2), 0, innerWidth);
        var verticalMiddle = math.clamp(Math.round(rect.top + rect.height / 2), 0, innerHeight);
        var elements = [
        ...
        var nonNull = elements.filter(miscellaneous.isPresent);
        if (!nonNull.length) {
            return nonNull;
        }
    ...
    function getElementOffset(host, element) {
        classes.tuiAssert.assert(host.contains(element), "Host must contain element");
    ...
    exports.containsOrAfter = containsOrAfter;
    exports.getActualTarget = getActualTarget;
    exports.getClipboardDataText = getClipboardDataText;
    exports.getClosestElement = getClosestElement;
    exports.getDocumentOrShadowRoot = getDocumentOrShadowRoot;
    exports.getElementObscurers = getElementObscurers;
    exports.getElementOffset = getElementOffset;
    exports.getScrollParent = getScrollParent;
    exports.isCurrentTarget = isCurrentTarget;
    ...
    exports.tuiIsFormFieldElement = tuiIsFormFieldElement;
