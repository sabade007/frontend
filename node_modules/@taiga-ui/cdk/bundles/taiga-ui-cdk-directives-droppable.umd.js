(function (global, factory) {
    ...
    (global = global || self, factory((global['taiga-ui'] = global['taiga-ui'] || {}, global['taiga-ui'].cdk = global['taiga-ui'].cdk || {}, global['taiga-ui'].cdk.directives = global['taiga-ui'].cdk.directives || {}, global['taiga-ui'].cdk.directives.droppable = {}), global.ng.core, global['taiga-ui'].cdk.observables, global['taiga-ui'].cdk.services, global['taiga-ui'].cdk.utils.miscellaneous, global.rxjs, global.rxjs.operators));
}(this, (function (exports, core, observables, services, miscellaneous, rxjs, operators) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var TuiDroppableDirective = /** @class */ (function () {
        function TuiDroppableDirective(_a, destroy$) {
            ...
            this.tuiDroppableDropped = observables.typedFromEvent(nativeElement, 'drop').pipe(observables.preventDefault(), operators.map(function (event) { return event.dataTransfer; }), operators.filter(miscellaneous.isPresent));
            this.tuiDroppableDragOverChange = observables.typedFromEvent(nativeElement, 'dragenter').pipe(operators.switchMap(function (_a) {
                var target = _a.target, dataTransfer = _a.dataTransfer;
                return rxjs.merge(observables.typedFromEvent(nativeElement, 'dragleave').pipe(operators.filter(function (event) { return event.target === target; })), observables.typedFromEvent(nativeElement, 'drop')).pipe(operators.mapTo(null), operators.startWith(dataTransfer));
            }), operators.distinctUntilChanged(function (a, b) { return (!!a && !!b) || (!a && !b); }));
            // Required by Drag and Drop API to stop redirecting
            observables.typedFromEvent(nativeElement, 'dragover')
                .pipe(observables.preventDefault(), operators.takeUntil(destroy$))
                .subscribe();
        }
        TuiDroppableDirective.ctorParameters = function () { return [
            { type: core.ElementRef, decorators: [{ type: core.Inject, args: [core.ElementRef,] }] },
            { type: rxjs.Observable, decorators: [{ type: core.Inject, args: [services.TuiDestroyService,] }] }
        ]; };
        __decorate([
            core.Output()
        ...
        TuiDroppableDirective = __decorate([
            ...
            __param(1, core.Inject(services.TuiDestroyService))
